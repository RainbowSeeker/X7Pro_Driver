...
//
//    if (fd < 0) {
//        printf("parameter file open fail!\n");
//        return E_RROR;
//    }
//
//    /* add title */
...
//                    break;
//                default:
//                    printf("unknow parameter type:%d\n", p->type);
//                    break;
//            }
//
//            p++;
