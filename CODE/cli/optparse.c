...
int optparse_error(optparse_t *options, const char *msg, const char *data)
{
    unsigned p = 0;
    const char *sep = " -- '";
    while (*msg)
...
static void optparse_permute(optparse_t *options, int index)
{
...
static void optparse_from_long(const optparse_long_t *longopts, char *optstring)
{
    char *p = optstring;
    int i;
...
static int optparse_long_fallback(optparse_t *options,
