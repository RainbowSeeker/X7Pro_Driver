 ...
 */
static_inline uint16_t mavlink_msg_play_tune_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static_inline uint16_t mavlink_msg_play_tune_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static_inline uint16_t mavlink_msg_play_tune_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_play_tune_t* play_tune)
{
 ...
 * @param play_tune C-struct to read the message contents from
 */
static_inline uint16_t mavlink_msg_play_tune_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_play_tune_t* play_tune)
{
...
static_inline void mavlink_msg_play_tune_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, const char* tune, const char* tune2)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PLAY_TUNE_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
 ...
 */
static_inline void mavlink_msg_play_tune_send_struct(mavlink_channel_t chan, const mavlink_play_tune_t* play_tune)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline void mavlink_msg_play_tune_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, const char* tune, const char* tune2)
{
        #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  System ID
 */
static_inline uint8_t mavlink_msg_play_tune_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return  Component ID
 */
static_inline uint8_t mavlink_msg_play_tune_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_play_tune_get_tune(const mavlink_message_t* msg, char* tune)
{
 ...
 */
static_inline uint16_t mavlink_msg_play_tune_get_tune2(const mavlink_message_t* msg, char* tune2)
{
 ...
 */
static_inline void mavlink_msg_play_tune_decode(const mavlink_message_t* msg, mavlink_play_tune_t* play_tune)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
