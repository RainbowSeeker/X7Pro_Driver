 ...
 */
__STATIC_INLINE uint16_t mavlink_msg_set_home_position_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
__STATIC_INLINE uint16_t mavlink_msg_set_home_position_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
__STATIC_INLINE uint16_t mavlink_msg_set_home_position_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_set_home_position_t* set_home_position)
{
 ...
 * @param set_home_position C-struct to read the message contents from
 */
__STATIC_INLINE uint16_t mavlink_msg_set_home_position_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_set_home_position_t* set_home_position)
{
...
__STATIC_INLINE void mavlink_msg_set_home_position_send(mavlink_channel_t chan, uint8_t target_system, int32_t latitude, int32_t longitude, int32_t altitude, float x, float y, float z, const float* q, float approach_x, float approach_y, float approach_z, uint64_t time_usec)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SET_HOME_POSITION_LEN];
    _mav_put_int32_t(buf, 0, latitude);
 ...
 */
__STATIC_INLINE void mavlink_msg_set_home_position_send_struct(mavlink_channel_t chan, const mavlink_set_home_position_t* set_home_position)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
__STATIC_INLINE void mavlink_msg_set_home_position_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target_system, int32_t latitude, int32_t longitude, int32_t altitude, float x, float y, float z, const float* q, float approach_x, float approach_y, float approach_z, uint64_t time_usec)
{
        #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  System ID.
 */
__STATIC_INLINE uint8_t mavlink_msg_set_home_position_get_target_system(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE int32_t mavlink_msg_set_home_position_get_latitude(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE int32_t mavlink_msg_set_home_position_get_longitude(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE int32_t mavlink_msg_set_home_position_get_altitude(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE float mavlink_msg_set_home_position_get_x(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE float mavlink_msg_set_home_position_get_y(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE float mavlink_msg_set_home_position_get_z(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE uint16_t mavlink_msg_set_home_position_get_q(const mavlink_message_t* msg, float* q)
{
 ...
 */
__STATIC_INLINE float mavlink_msg_set_home_position_get_approach_x(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE float mavlink_msg_set_home_position_get_approach_y(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE float mavlink_msg_set_home_position_get_approach_z(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE uint64_t mavlink_msg_set_home_position_get_time_usec(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE void mavlink_msg_set_home_position_decode(const mavlink_message_t* msg, mavlink_set_home_position_t* set_home_position)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
