 ...
 */
__STATIC_INLINE uint16_t mavlink_msg_logging_data_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
__STATIC_INLINE uint16_t mavlink_msg_logging_data_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
__STATIC_INLINE uint16_t mavlink_msg_logging_data_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_logging_data_t* logging_data)
{
 ...
 * @param logging_data C-struct to read the message contents from
 */
__STATIC_INLINE uint16_t mavlink_msg_logging_data_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_logging_data_t* logging_data)
{
...
__STATIC_INLINE void mavlink_msg_logging_data_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t sequence, uint8_t length, uint8_t first_message_offset, const uint8_t* data)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_LOGGING_DATA_LEN];
    _mav_put_uint16_t(buf, 0, sequence);
 ...
 */
__STATIC_INLINE void mavlink_msg_logging_data_send_struct(mavlink_channel_t chan, const mavlink_logging_data_t* logging_data)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
__STATIC_INLINE void mavlink_msg_logging_data_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t sequence, uint8_t length, uint8_t first_message_offset, const uint8_t* data)
{
        #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
__STATIC_INLINE uint8_t mavlink_msg_logging_data_get_target_system(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE uint8_t mavlink_msg_logging_data_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE uint16_t mavlink_msg_logging_data_get_sequence(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE uint8_t mavlink_msg_logging_data_get_length(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE uint8_t mavlink_msg_logging_data_get_first_message_offset(const mavlink_message_t* msg)
{
 ...
 * @return  logged data
 */
__STATIC_INLINE uint16_t mavlink_msg_logging_data_get_data(const mavlink_message_t* msg, uint8_t* data)
{
 ...
 */
__STATIC_INLINE void mavlink_msg_logging_data_decode(const mavlink_message_t* msg, mavlink_logging_data_t* logging_data)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
