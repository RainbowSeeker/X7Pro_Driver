 ...
 */
static_inline uint16_t mavlink_msg_esc_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static_inline uint16_t mavlink_msg_esc_status_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static_inline uint16_t mavlink_msg_esc_status_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_esc_status_t* esc_status)
{
 ...
 * @param esc_status C-struct to read the message contents from
 */
static_inline uint16_t mavlink_msg_esc_status_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_esc_status_t* esc_status)
{
...
static_inline void mavlink_msg_esc_status_send(mavlink_channel_t chan, uint8_t index, uint64_t time_usec, const int32_t* rpm, const float* voltage, const float* current)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_ESC_STATUS_LEN];
    _mav_put_uint64_t(buf, 0, time_usec);
 ...
 */
static_inline void mavlink_msg_esc_status_send_struct(mavlink_channel_t chan, const mavlink_esc_status_t* esc_status)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline void mavlink_msg_esc_status_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t index, uint64_t time_usec, const int32_t* rpm, const float* voltage, const float* current)
{
        #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline uint8_t mavlink_msg_esc_status_get_index(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint64_t mavlink_msg_esc_status_get_time_usec(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_esc_status_get_rpm(const mavlink_message_t* msg, int32_t* rpm)
{
 ...
 */
static_inline uint16_t mavlink_msg_esc_status_get_voltage(const mavlink_message_t* msg, float* voltage)
{
 ...
 */
static_inline uint16_t mavlink_msg_esc_status_get_current(const mavlink_message_t* msg, float* current)
{
 ...
 */
static_inline void mavlink_msg_esc_status_decode(const mavlink_message_t* msg, mavlink_esc_status_t* esc_status)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
