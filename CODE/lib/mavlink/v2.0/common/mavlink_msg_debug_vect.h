 ...
 */
static_inline uint16_t mavlink_msg_debug_vect_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static_inline uint16_t mavlink_msg_debug_vect_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static_inline uint16_t mavlink_msg_debug_vect_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_debug_vect_t* debug_vect)
{
 ...
 * @param debug_vect C-struct to read the message contents from
 */
static_inline uint16_t mavlink_msg_debug_vect_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_debug_vect_t* debug_vect)
{
...
static_inline void mavlink_msg_debug_vect_send(mavlink_channel_t chan, const char* name, uint64_t time_usec, float x, float y, float z)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_DEBUG_VECT_LEN];
    _mav_put_uint64_t(buf, 0, time_usec);
 ...
 */
static_inline void mavlink_msg_debug_vect_send_struct(mavlink_channel_t chan, const mavlink_debug_vect_t* debug_vect)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline void mavlink_msg_debug_vect_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan, const char* name, uint64_t time_usec, float x, float y, float z)
{
        #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  Name
 */
static_inline uint16_t mavlink_msg_debug_vect_get_name(const mavlink_message_t* msg, char* name)
{
 ...
 */
static_inline uint64_t mavlink_msg_debug_vect_get_time_usec(const mavlink_message_t* msg)
{
 ...
 * @return  x
 */
static_inline float mavlink_msg_debug_vect_get_x(const mavlink_message_t* msg)
{
 ...
 * @return  y
 */
static_inline float mavlink_msg_debug_vect_get_y(const mavlink_message_t* msg)
{
 ...
 * @return  z
 */
static_inline float mavlink_msg_debug_vect_get_z(const mavlink_message_t* msg)
{
 ...
 */
static_inline void mavlink_msg_debug_vect_decode(const mavlink_message_t* msg, mavlink_debug_vect_t* debug_vect)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
