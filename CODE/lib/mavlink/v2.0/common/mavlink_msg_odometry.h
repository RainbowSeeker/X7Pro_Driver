 ...
 */
static_inline uint16_t mavlink_msg_odometry_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static_inline uint16_t mavlink_msg_odometry_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static_inline uint16_t mavlink_msg_odometry_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_odometry_t* odometry)
{
 ...
 * @param odometry C-struct to read the message contents from
 */
static_inline uint16_t mavlink_msg_odometry_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_odometry_t* odometry)
{
 ...
 */
static_inline void mavlink_msg_odometry_send_struct(mavlink_channel_t chan, const mavlink_odometry_t* odometry)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline void mavlink_msg_odometry_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan, uint64_t time_usec, uint8_t frame_id, uint8_t child_frame_id, float x, float y, float z, const float* q, float vx, float vy, float vz, float rollspeed, float pitchspeed, float yawspeed, const float* pose_covariance, const float* velocity_covariance, uint8_t reset_counter, uint8_t estimator_type)
{
        #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline uint64_t mavlink_msg_odometry_get_time_usec(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint8_t mavlink_msg_odometry_get_frame_id(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint8_t mavlink_msg_odometry_get_child_frame_id(const mavlink_message_t* msg)
{
 ...
 * @return [m] X Position
 */
static_inline float mavlink_msg_odometry_get_x(const mavlink_message_t* msg)
{
 ...
 * @return [m] Y Position
 */
static_inline float mavlink_msg_odometry_get_y(const mavlink_message_t* msg)
{
 ...
 * @return [m] Z Position
 */
static_inline float mavlink_msg_odometry_get_z(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_odometry_get_q(const mavlink_message_t* msg, float* q)
{
 ...
 */
static_inline float mavlink_msg_odometry_get_vx(const mavlink_message_t* msg)
{
 ...
 */
static_inline float mavlink_msg_odometry_get_vy(const mavlink_message_t* msg)
{
 ...
 */
static_inline float mavlink_msg_odometry_get_vz(const mavlink_message_t* msg)
{
 ...
 */
static_inline float mavlink_msg_odometry_get_rollspeed(const mavlink_message_t* msg)
{
 ...
 */
static_inline float mavlink_msg_odometry_get_pitchspeed(const mavlink_message_t* msg)
{
 ...
 */
static_inline float mavlink_msg_odometry_get_yawspeed(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_odometry_get_pose_covariance(const mavlink_message_t* msg, float* pose_covariance)
{
 ...
 */
static_inline uint16_t mavlink_msg_odometry_get_velocity_covariance(const mavlink_message_t* msg, float* velocity_covariance)
{
 ...
 */
static_inline uint8_t mavlink_msg_odometry_get_reset_counter(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint8_t mavlink_msg_odometry_get_estimator_type(const mavlink_message_t* msg)
{
 ...
 */
static_inline void mavlink_msg_odometry_decode(const mavlink_message_t* msg, mavlink_odometry_t* odometry)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
