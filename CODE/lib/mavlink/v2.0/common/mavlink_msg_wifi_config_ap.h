 ...
 */
static_inline uint16_t mavlink_msg_wifi_config_ap_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static_inline uint16_t mavlink_msg_wifi_config_ap_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static_inline uint16_t mavlink_msg_wifi_config_ap_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_wifi_config_ap_t* wifi_config_ap)
{
 ...
 * @param wifi_config_ap C-struct to read the message contents from
 */
static_inline uint16_t mavlink_msg_wifi_config_ap_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_wifi_config_ap_t* wifi_config_ap)
{
...
static_inline void mavlink_msg_wifi_config_ap_send(mavlink_channel_t chan, const char* ssid, const char* password, int8_t mode, int8_t response)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_WIFI_CONFIG_AP_LEN];
    _mav_put_int8_t(buf, 96, mode);
 ...
 */
static_inline void mavlink_msg_wifi_config_ap_send_struct(mavlink_channel_t chan, const mavlink_wifi_config_ap_t* wifi_config_ap)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline void mavlink_msg_wifi_config_ap_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan, const char* ssid, const char* password, int8_t mode, int8_t response)
{
        #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline uint16_t mavlink_msg_wifi_config_ap_get_ssid(const mavlink_message_t* msg, char* ssid)
{
 ...
 */
static_inline uint16_t mavlink_msg_wifi_config_ap_get_password(const mavlink_message_t* msg, char* password)
{
 ...
 * @return  WiFi Mode.
 */
static_inline int8_t mavlink_msg_wifi_config_ap_get_mode(const mavlink_message_t* msg)
{
 ...
 */
static_inline int8_t mavlink_msg_wifi_config_ap_get_response(const mavlink_message_t* msg)
{
 ...
 */
static_inline void mavlink_msg_wifi_config_ap_decode(const mavlink_message_t* msg, mavlink_wifi_config_ap_t* wifi_config_ap)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
