 ...
 */
__STATIC_INLINE uint16_t mavlink_msg_param_ext_request_read_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
__STATIC_INLINE uint16_t mavlink_msg_param_ext_request_read_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
__STATIC_INLINE uint16_t mavlink_msg_param_ext_request_read_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_param_ext_request_read_t* param_ext_request_read)
{
 ...
 * @param param_ext_request_read C-struct to read the message contents from
 */
__STATIC_INLINE uint16_t mavlink_msg_param_ext_request_read_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_param_ext_request_read_t* param_ext_request_read)
{
...
__STATIC_INLINE void mavlink_msg_param_ext_request_read_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, const char* param_id, int16_t param_index)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ_LEN];
    _mav_put_int16_t(buf, 0, param_index);
 ...
 */
__STATIC_INLINE void mavlink_msg_param_ext_request_read_send_struct(mavlink_channel_t chan, const mavlink_param_ext_request_read_t* param_ext_request_read)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
__STATIC_INLINE void mavlink_msg_param_ext_request_read_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, const char* param_id, int16_t param_index)
{
        #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  System ID
 */
__STATIC_INLINE uint8_t mavlink_msg_param_ext_request_read_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return  Component ID
 */
__STATIC_INLINE uint8_t mavlink_msg_param_ext_request_read_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE uint16_t mavlink_msg_param_ext_request_read_get_param_id(const mavlink_message_t* msg, char* param_id)
{
 ...
 */
__STATIC_INLINE int16_t mavlink_msg_param_ext_request_read_get_param_index(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE void mavlink_msg_param_ext_request_read_decode(const mavlink_message_t* msg, mavlink_param_ext_request_read_t* param_ext_request_read)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
