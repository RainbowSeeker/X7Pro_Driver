 ...
 */
static_inline uint16_t mavlink_msg_radio_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static_inline uint16_t mavlink_msg_radio_status_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static_inline uint16_t mavlink_msg_radio_status_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_radio_status_t* radio_status)
{
 ...
 * @param radio_status C-struct to read the message contents from
 */
static_inline uint16_t mavlink_msg_radio_status_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_radio_status_t* radio_status)
{
...
static_inline void mavlink_msg_radio_status_send(mavlink_channel_t chan, uint8_t rssi, uint8_t remrssi, uint8_t txbuf, uint8_t noise, uint8_t remnoise, uint16_t rxerrors, uint16_t fixed)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_RADIO_STATUS_LEN];
    _mav_put_uint16_t(buf, 0, rxerrors);
 ...
 */
static_inline void mavlink_msg_radio_status_send_struct(mavlink_channel_t chan, const mavlink_radio_status_t* radio_status)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline void mavlink_msg_radio_status_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t rssi, uint8_t remrssi, uint8_t txbuf, uint8_t noise, uint8_t remnoise, uint16_t rxerrors, uint16_t fixed)
{
        #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline uint8_t mavlink_msg_radio_status_get_rssi(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint8_t mavlink_msg_radio_status_get_remrssi(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint8_t mavlink_msg_radio_status_get_txbuf(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint8_t mavlink_msg_radio_status_get_noise(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint8_t mavlink_msg_radio_status_get_remnoise(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_radio_status_get_rxerrors(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_radio_status_get_fixed(const mavlink_message_t* msg)
{
 ...
 */
static_inline void mavlink_msg_radio_status_decode(const mavlink_message_t* msg, mavlink_radio_status_t* radio_status)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
