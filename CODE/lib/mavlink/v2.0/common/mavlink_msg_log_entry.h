 ...
 */
static_inline uint16_t mavlink_msg_log_entry_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static_inline uint16_t mavlink_msg_log_entry_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static_inline uint16_t mavlink_msg_log_entry_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_log_entry_t* log_entry)
{
 ...
 * @param log_entry C-struct to read the message contents from
 */
static_inline uint16_t mavlink_msg_log_entry_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_log_entry_t* log_entry)
{
...
static_inline void mavlink_msg_log_entry_send(mavlink_channel_t chan, uint16_t id, uint16_t num_logs, uint16_t last_log_num, uint32_t time_utc, uint32_t size)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_LOG_ENTRY_LEN];
    _mav_put_uint32_t(buf, 0, time_utc);
 ...
 */
static_inline void mavlink_msg_log_entry_send_struct(mavlink_channel_t chan, const mavlink_log_entry_t* log_entry)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline void mavlink_msg_log_entry_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan, uint16_t id, uint16_t num_logs, uint16_t last_log_num, uint32_t time_utc, uint32_t size)
{
        #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  Log id
 */
static_inline uint16_t mavlink_msg_log_entry_get_id(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_log_entry_get_num_logs(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_log_entry_get_last_log_num(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint32_t mavlink_msg_log_entry_get_time_utc(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint32_t mavlink_msg_log_entry_get_size(const mavlink_message_t* msg)
{
 ...
 */
static_inline void mavlink_msg_log_entry_decode(const mavlink_message_t* msg, mavlink_log_entry_t* log_entry)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
