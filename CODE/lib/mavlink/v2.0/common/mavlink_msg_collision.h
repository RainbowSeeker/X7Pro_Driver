 ...
 */
static_inline uint16_t mavlink_msg_collision_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static_inline uint16_t mavlink_msg_collision_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static_inline uint16_t mavlink_msg_collision_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_collision_t* collision)
{
 ...
 * @param collision C-struct to read the message contents from
 */
static_inline uint16_t mavlink_msg_collision_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_collision_t* collision)
{
...
static_inline void mavlink_msg_collision_send(mavlink_channel_t chan, uint8_t src, uint32_t id, uint8_t action, uint8_t threat_level, float time_to_minimum_delta, float altitude_minimum_delta, float horizontal_minimum_delta)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_COLLISION_LEN];
    _mav_put_uint32_t(buf, 0, id);
 ...
 */
static_inline void mavlink_msg_collision_send_struct(mavlink_channel_t chan, const mavlink_collision_t* collision)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline void mavlink_msg_collision_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t src, uint32_t id, uint8_t action, uint8_t threat_level, float time_to_minimum_delta, float altitude_minimum_delta, float horizontal_minimum_delta)
{
        #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline uint8_t mavlink_msg_collision_get_src(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint32_t mavlink_msg_collision_get_id(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint8_t mavlink_msg_collision_get_action(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint8_t mavlink_msg_collision_get_threat_level(const mavlink_message_t* msg)
{
 ...
 */
static_inline float mavlink_msg_collision_get_time_to_minimum_delta(const mavlink_message_t* msg)
{
 ...
 */
static_inline float mavlink_msg_collision_get_altitude_minimum_delta(const mavlink_message_t* msg)
{
 ...
 */
static_inline float mavlink_msg_collision_get_horizontal_minimum_delta(const mavlink_message_t* msg)
{
 ...
 */
static_inline void mavlink_msg_collision_decode(const mavlink_message_t* msg, mavlink_collision_t* collision)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
