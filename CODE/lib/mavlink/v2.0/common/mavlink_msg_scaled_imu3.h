 ...
 */
static_inline uint16_t mavlink_msg_scaled_imu3_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static_inline uint16_t mavlink_msg_scaled_imu3_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static_inline uint16_t mavlink_msg_scaled_imu3_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_scaled_imu3_t* scaled_imu3)
{
 ...
 * @param scaled_imu3 C-struct to read the message contents from
 */
static_inline uint16_t mavlink_msg_scaled_imu3_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_scaled_imu3_t* scaled_imu3)
{
...
static_inline void mavlink_msg_scaled_imu3_send(mavlink_channel_t chan, uint32_t time_boot_ms, int16_t xacc, int16_t yacc, int16_t zacc, int16_t xgyro, int16_t ygyro, int16_t zgyro, int16_t xmag, int16_t ymag, int16_t zmag, int16_t temperature)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SCALED_IMU3_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static_inline void mavlink_msg_scaled_imu3_send_struct(mavlink_channel_t chan, const mavlink_scaled_imu3_t* scaled_imu3)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline void mavlink_msg_scaled_imu3_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan, uint32_t time_boot_ms, int16_t xacc, int16_t yacc, int16_t zacc, int16_t xgyro, int16_t ygyro, int16_t zgyro, int16_t xmag, int16_t ymag, int16_t zmag, int16_t temperature)
{
        #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline uint32_t mavlink_msg_scaled_imu3_get_time_boot_ms(const mavlink_message_t* msg)
{
 ...
 */
static_inline int16_t mavlink_msg_scaled_imu3_get_xacc(const mavlink_message_t* msg)
{
 ...
 */
static_inline int16_t mavlink_msg_scaled_imu3_get_yacc(const mavlink_message_t* msg)
{
 ...
 */
static_inline int16_t mavlink_msg_scaled_imu3_get_zacc(const mavlink_message_t* msg)
{
 ...
 */
static_inline int16_t mavlink_msg_scaled_imu3_get_xgyro(const mavlink_message_t* msg)
{
 ...
 */
static_inline int16_t mavlink_msg_scaled_imu3_get_ygyro(const mavlink_message_t* msg)
{
 ...
 */
static_inline int16_t mavlink_msg_scaled_imu3_get_zgyro(const mavlink_message_t* msg)
{
 ...
 */
static_inline int16_t mavlink_msg_scaled_imu3_get_xmag(const mavlink_message_t* msg)
{
 ...
 */
static_inline int16_t mavlink_msg_scaled_imu3_get_ymag(const mavlink_message_t* msg)
{
 ...
 */
static_inline int16_t mavlink_msg_scaled_imu3_get_zmag(const mavlink_message_t* msg)
{
 ...
 */
static_inline int16_t mavlink_msg_scaled_imu3_get_temperature(const mavlink_message_t* msg)
{
 ...
 */
static_inline void mavlink_msg_scaled_imu3_decode(const mavlink_message_t* msg, mavlink_scaled_imu3_t* scaled_imu3)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
