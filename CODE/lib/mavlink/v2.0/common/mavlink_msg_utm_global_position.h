 ...
 */
static_inline uint16_t mavlink_msg_utm_global_position_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static_inline uint16_t mavlink_msg_utm_global_position_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static_inline uint16_t mavlink_msg_utm_global_position_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_utm_global_position_t* utm_global_position)
{
 ...
 * @param utm_global_position C-struct to read the message contents from
 */
static_inline uint16_t mavlink_msg_utm_global_position_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_utm_global_position_t* utm_global_position)
{
 ...
 */
static_inline void mavlink_msg_utm_global_position_send_struct(mavlink_channel_t chan, const mavlink_utm_global_position_t* utm_global_position)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline void mavlink_msg_utm_global_position_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan, uint64_t time, const uint8_t* uas_id, int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, int16_t vx, int16_t vy, int16_t vz, uint16_t h_acc, uint16_t v_acc, uint16_t vel_acc, int32_t next_lat, int32_t next_lon, int32_t next_alt, uint16_t update_rate, uint8_t flight_state, uint8_t flags)
{
        #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline uint64_t mavlink_msg_utm_global_position_get_time(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_utm_global_position_get_uas_id(const mavlink_message_t* msg, uint8_t* uas_id)
{
 ...
 */
static_inline int32_t mavlink_msg_utm_global_position_get_lat(const mavlink_message_t* msg)
{
 ...
 */
static_inline int32_t mavlink_msg_utm_global_position_get_lon(const mavlink_message_t* msg)
{
 ...
 */
static_inline int32_t mavlink_msg_utm_global_position_get_alt(const mavlink_message_t* msg)
{
 ...
 */
static_inline int32_t mavlink_msg_utm_global_position_get_relative_alt(const mavlink_message_t* msg)
{
 ...
 */
static_inline int16_t mavlink_msg_utm_global_position_get_vx(const mavlink_message_t* msg)
{
 ...
 */
static_inline int16_t mavlink_msg_utm_global_position_get_vy(const mavlink_message_t* msg)
{
 ...
 */
static_inline int16_t mavlink_msg_utm_global_position_get_vz(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_utm_global_position_get_h_acc(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_utm_global_position_get_v_acc(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_utm_global_position_get_vel_acc(const mavlink_message_t* msg)
{
 ...
 */
static_inline int32_t mavlink_msg_utm_global_position_get_next_lat(const mavlink_message_t* msg)
{
 ...
 */
static_inline int32_t mavlink_msg_utm_global_position_get_next_lon(const mavlink_message_t* msg)
{
 ...
 */
static_inline int32_t mavlink_msg_utm_global_position_get_next_alt(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_utm_global_position_get_update_rate(const mavlink_message_t* msg)
{
 ...
 * @return  Flight state
 */
static_inline uint8_t mavlink_msg_utm_global_position_get_flight_state(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint8_t mavlink_msg_utm_global_position_get_flags(const mavlink_message_t* msg)
{
 ...
 */
static_inline void mavlink_msg_utm_global_position_decode(const mavlink_message_t* msg, mavlink_utm_global_position_t* utm_global_position)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
