 ...
 */
__STATIC_INLINE uint16_t mavlink_msg_mission_item_reached_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                                                             uint16_t seq)
{
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
__STATIC_INLINE uint16_t mavlink_msg_mission_item_reached_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
__STATIC_INLINE uint16_t mavlink_msg_mission_item_reached_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_mission_item_reached_t* mission_item_reached)
{
 ...
 * @param mission_item_reached C-struct to read the message contents from
 */
__STATIC_INLINE uint16_t mavlink_msg_mission_item_reached_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_mission_item_reached_t* mission_item_reached)
{
...
__STATIC_INLINE void mavlink_msg_mission_item_reached_send(mavlink_channel_t chan, uint16_t seq)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MISSION_ITEM_REACHED_LEN];
    _mav_put_uint16_t(buf, 0, seq);
 ...
 */
__STATIC_INLINE void mavlink_msg_mission_item_reached_send_struct(mavlink_channel_t chan, const mavlink_mission_item_reached_t* mission_item_reached)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
__STATIC_INLINE void mavlink_msg_mission_item_reached_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan, uint16_t seq)
{
        #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  Sequence
 */
__STATIC_INLINE uint16_t mavlink_msg_mission_item_reached_get_seq(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE void mavlink_msg_mission_item_reached_decode(const mavlink_message_t* msg, mavlink_mission_item_reached_t* mission_item_reached)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
