 ...
 */
__STATIC_INLINE uint16_t mavlink_msg_param_v3_set_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
__STATIC_INLINE uint16_t mavlink_msg_param_v3_set_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
__STATIC_INLINE uint16_t mavlink_msg_param_v3_set_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_param_v3_set_t* param_v3_set)
{
 ...
 * @param param_v3_set C-struct to read the message contents from
 */
__STATIC_INLINE uint16_t mavlink_msg_param_v3_set_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_param_v3_set_t* param_v3_set)
{
...
__STATIC_INLINE void mavlink_msg_param_v3_set_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, const char* param_id, uint8_t param_type, const char* param_value)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PARAM_V3_SET_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
 ...
 */
__STATIC_INLINE void mavlink_msg_param_v3_set_send_struct(mavlink_channel_t chan, const mavlink_param_v3_set_t* param_v3_set)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
__STATIC_INLINE void mavlink_msg_param_v3_set_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, const char* param_id, uint8_t param_type, const char* param_value)
{
        #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  System ID
 */
__STATIC_INLINE uint8_t mavlink_msg_param_v3_set_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return  Component ID
 */
__STATIC_INLINE uint8_t mavlink_msg_param_v3_set_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE uint16_t mavlink_msg_param_v3_set_get_param_id(const mavlink_message_t* msg, char* param_id)
{
 ...
 */
__STATIC_INLINE uint8_t mavlink_msg_param_v3_set_get_param_type(const mavlink_message_t* msg)
{
 ...
 */
__STATIC_INLINE uint16_t mavlink_msg_param_v3_set_get_param_value(const mavlink_message_t* msg, char* param_value)
{
 ...
 */
__STATIC_INLINE void mavlink_msg_param_v3_set_decode(const mavlink_message_t* msg, mavlink_param_v3_set_t* param_v3_set)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
