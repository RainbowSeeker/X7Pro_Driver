 ...
 */
static_inline uint16_t mavlink_msg_ais_vessel_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static_inline uint16_t mavlink_msg_ais_vessel_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static_inline uint16_t mavlink_msg_ais_vessel_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_ais_vessel_t* ais_vessel)
{
 ...
 * @param ais_vessel C-struct to read the message contents from
 */
static_inline uint16_t mavlink_msg_ais_vessel_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_ais_vessel_t* ais_vessel)
{
 ...
 */
static_inline void mavlink_msg_ais_vessel_send_struct(mavlink_channel_t chan, const mavlink_ais_vessel_t* ais_vessel)
{
    #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline void mavlink_msg_ais_vessel_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan, uint32_t MMSI, int32_t lat, int32_t lon, uint16_t COG, uint16_t heading, uint16_t velocity, int8_t turn_rate, uint8_t navigational_status, uint8_t type, uint16_t dimension_bow, uint16_t dimension_stern, uint8_t dimension_port, uint8_t dimension_starboard, const char* callsign, const char* name, uint16_t tslc, uint16_t flags)
{
        #if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static_inline uint32_t mavlink_msg_ais_vessel_get_MMSI(const mavlink_message_t* msg)
{
 ...
 */
static_inline int32_t mavlink_msg_ais_vessel_get_lat(const mavlink_message_t* msg)
{
 ...
 */
static_inline int32_t mavlink_msg_ais_vessel_get_lon(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_ais_vessel_get_COG(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_ais_vessel_get_heading(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_ais_vessel_get_velocity(const mavlink_message_t* msg)
{
 ...
 */
static_inline int8_t mavlink_msg_ais_vessel_get_turn_rate(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint8_t mavlink_msg_ais_vessel_get_navigational_status(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint8_t mavlink_msg_ais_vessel_get_type(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_ais_vessel_get_dimension_bow(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_ais_vessel_get_dimension_stern(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint8_t mavlink_msg_ais_vessel_get_dimension_port(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint8_t mavlink_msg_ais_vessel_get_dimension_starboard(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_ais_vessel_get_callsign(const mavlink_message_t* msg, char* callsign)
{
 ...
 */
static_inline uint16_t mavlink_msg_ais_vessel_get_name(const mavlink_message_t* msg, char* name)
{
 ...
 */
static_inline uint16_t mavlink_msg_ais_vessel_get_tslc(const mavlink_message_t* msg)
{
 ...
 */
static_inline uint16_t mavlink_msg_ais_vessel_get_flags(const mavlink_message_t* msg)
{
 ...
 */
static_inline void mavlink_msg_ais_vessel_decode(const mavlink_message_t* msg, mavlink_ais_vessel_t* ais_vessel)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
