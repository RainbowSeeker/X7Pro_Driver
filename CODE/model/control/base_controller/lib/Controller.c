...
{
  int32_T i;
  int32_T rtb_Saturation_1;
  int32_T rtb_Saturation_2;
  int32_T u;
  ...
  if ((Controller_U.FMS_Out.reset != 0) ||
    ...
    Controller_DW.DiscreteTimeIntegrator_DSTATE = Controller_ConstB.Constant_b;
   ...
   *  Constant: '<S65>/kd'
   */
  u0 *= CONTROL_PARAM.VEL_Z_D;

  /* Saturate: '<S65>/Saturation' */
  if (u0 > CONTROL_PARAM.VEL_Z_D_MAX) {
    u0 = CONTROL_PARAM.VEL_Z_D_MAX;
  } else if (u0 < CONTROL_PARAM.VEL_Z_D_MIN) {
    u0 = CONTROL_PARAM.VEL_Z_D_MIN;
  }
   ...
   */
  rtb_DiscreteTimeIntegrator1_b_i = arm_cos_f32(Controller_U.INS_Out.theta);
   ...
   */
  rtb_rate_error_B_radPs_idx_1 = rtb_rate_error_B_radPs_idx_0 *
    rtb_DiscreteTimeIntegrator1_b_i;

  /* Saturate: '<S60>/Saturation1' incorporates:
   *  Product: '<S60>/Multiply'
   */
  if (rtb_rate_error_B_radPs_idx_1 < 0.5F) {
    y = 0.5F;
  } else {
    y = rtb_rate_error_B_radPs_idx_1;
  }

  /* Gain: '<S60>/Gain' incorporates:
   *  Product: '<S60>/Multiply'
   */
  u0 = 2.0F * rtb_rate_error_B_radPs_idx_1;
   ...
   */
  if (rtb_rate_error_B_radPs_idx_1 < 0.5F) {
    rtb_Subtract3_i_idx_0 = 0.5F;
  } else {
    rtb_Subtract3_i_idx_0 = rtb_rate_error_B_radPs_idx_1;
  }
   ...
   *  Product: '<S60>/Divide'
   */
  rtb_Subtract3_i_idx_0 = 1.0F / rtb_Subtract3_i_idx_0 * rtb_Add * u0;
   ...
   *  Inport: '<Root>/INS_Out'
   *  SignalConversion generated from: '<S41>/Multiply'
   */
  for (i = 0; i < 3; i++) {
  ...
  if ((Controller_U.FMS_Out.reset != 0) ||
    ...
    if (Controller_DW.DiscreteTimeIntegrator_DSTATE_m[0] >=
      ...
      Controller_DW.DiscreteTimeIntegrator_DSTATE_m[0] =
        CONTROL_PARAM.VEL_XY_I_MAX;
    } else if (Controller_DW.DiscreteTimeIntegrator_DSTATE_m[0] <=
    ...
    if (Controller_DW.DiscreteTimeIntegrator_DSTATE_m[1] >=
      ...
      Controller_DW.DiscreteTimeIntegrator_DSTATE_m[1] =
        CONTROL_PARAM.VEL_XY_I_MAX;
    } else if (Controller_DW.DiscreteTimeIntegrator_DSTATE_m[1] <=
               CONTROL_PARAM.VEL_XY_I_MIN) {
      Controller_DW.DiscreteTimeIntegrator_DSTATE_m[1] =
        CONTROL_PARAM.VEL_XY_I_MIN;
    }
  ...
  if (Controller_U.FMS_Out.reset > 0) {
    ...
    rtb_Saturation_idx_0 = rtb_Gain_j_idx_0;
    rtb_Saturation_idx_1 = rtb_Gain_j_idx_1;
  }
   ...
   */
  rtb_Saturation_idx_0 *= CONTROL_PARAM.VEL_XY_D;
  rtb_Saturation_idx_1 *= CONTROL_PARAM.VEL_XY_D;
  ...
  if (Controller_U.FMS_Out.ctrl_mode == 6) {
    /* Saturate: '<S46>/Saturation' */
    if (rtb_Saturation_idx_0 > CONTROL_PARAM.VEL_XY_D_MAX) {
      rtb_Saturation_idx_0 = CONTROL_PARAM.VEL_XY_D_MAX;
    } else if (rtb_Saturation_idx_0 < CONTROL_PARAM.VEL_XY_D_MIN) {
      rtb_Saturation_idx_0 = CONTROL_PARAM.VEL_XY_D_MIN;
    }

    rtb_Saturation_idx_0 = ((Controller_U.FMS_Out.cmd_mask & 64) > 0 ?
      (CONTROL_PARAM.VEL_XY_P * rtb_uv_error_C_mPs_idx_0 +
       Controller_DW.DiscreteTimeIntegrator_DSTATE_m[0]) + rtb_Saturation_idx_0 :
     ...
     *  Sum: '<S51>/Sum1'
     */
    if (rtb_Saturation_idx_1 > CONTROL_PARAM.VEL_XY_D_MAX) {
      rtb_Saturation_idx_1 = CONTROL_PARAM.VEL_XY_D_MAX;
    } else if (rtb_Saturation_idx_1 < CONTROL_PARAM.VEL_XY_D_MIN) {
      rtb_Saturation_idx_1 = CONTROL_PARAM.VEL_XY_D_MIN;
    }

    rtb_Saturation_idx_1 = ((Controller_U.FMS_Out.cmd_mask & 128) > 0 ?
      (CONTROL_PARAM.VEL_XY_P * rtb_uv_error_C_mPs_idx_1 +
       Controller_DW.DiscreteTimeIntegrator_DSTATE_m[1]) + rtb_Saturation_idx_1 :
   ...
   *  Product: '<S37>/Divide'
   */
  rtb_Add3_j_idx_0 = 1.1F * -rtb_Saturation_idx_0 / 9.8055F;
  ...
  rtb_Saturation_idx_1 = atanf(rtb_Add3_j_idx_0);
   ...
   *  Constant: '<S32>/const2'
   */
  rtb_rate_error_B_radPs_idx_2 = fabsf(rtb_Saturation_idx_0) / 0.002F;

  /* Product: '<S32>/Divide' incorporates:
   *  Constant: '<S30>/Constant1'
   *  Constant: '<S32>/const1'
   *  Math: '<S32>/Square'
   *  SignalConversion generated from: '<S32>/Square'
   */
  rtb_Saturation_m = 9.5993F / (CONTROL_PARAM.ROLL_P * CONTROL_PARAM.ROLL_P);
  ...
  if (rtb_Saturation_idx_0 < 0.0F) {
    ...
    rtb_Multiply4_b = (real32_T)(rtb_Saturation_idx_0 > 0.0F);
  }
   ...
   *  Sum: '<S32>/Subtract'
   */
  if ((rtb_Saturation_idx_0 <= rtb_Saturation_m) && (rtb_Saturation_idx_0 >=
       -rtb_Saturation_m)) {
    rtb_Multiply4_b = rtb_Saturation_idx_0 * CONTROL_PARAM.ROLL_P;
  } else {
    rtb_Multiply4_b *= sqrtf((rtb_Multiply4_b * rtb_Saturation_idx_0 - 0.5F *
      rtb_Saturation_m) * Controller_ConstB.Gain);
  }
   ...
   *  Switch: '<S33>/Switch2'
   */
  if (rtb_Multiply4_b > rtb_rate_error_B_radPs_idx_2) {
    rtb_Multiply4_b = rtb_rate_error_B_radPs_idx_2;
  } else if (rtb_Multiply4_b < -rtb_rate_error_B_radPs_idx_2) {
  ...
  if (rtb_Multiply4_b > CONTROL_PARAM.P_Q_CMD_LIM) {
    rtb_Add3_j_idx_0 = CONTROL_PARAM.P_Q_CMD_LIM;
  } else if (rtb_Multiply4_b < -CONTROL_PARAM.P_Q_CMD_LIM) {
    rtb_Add3_j_idx_0 = -CONTROL_PARAM.P_Q_CMD_LIM;
  } else {
    rtb_Add3_j_idx_0 = rtb_Multiply4_b;
  }
   ...
   *  Constant: '<S32>/const2'
   */
  rtb_rate_error_B_radPs_idx_2 = fabsf(rtb_Saturation_idx_1) / 0.002F;
   ...
   *  SignalConversion generated from: '<S32>/Square'
   */
  rtb_Saturation_m = 9.5993F / (CONTROL_PARAM.PITCH_P * CONTROL_PARAM.PITCH_P);
  ...
  if (rtb_Saturation_idx_1 < 0.0F) {
    ...
    rtb_Multiply4_b = (real32_T)(rtb_Saturation_idx_1 > 0.0F);
  }
   ...
   *  Sum: '<S32>/Subtract'
   */
  if ((rtb_Saturation_idx_1 <= rtb_Saturation_m) && (rtb_Saturation_idx_1 >=
       -rtb_Saturation_m)) {
    rtb_Multiply4_b = rtb_Saturation_idx_1 * CONTROL_PARAM.PITCH_P;
  } else {
    rtb_Multiply4_b *= sqrtf((rtb_Multiply4_b * rtb_Saturation_idx_1 - 0.5F *
      rtb_Saturation_m) * Controller_ConstB.Gain);
  }
  ...
  if (rtb_Multiply4_b > CONTROL_PARAM.P_Q_CMD_LIM) {
    rtb_rate_error_B_radPs_idx_2 = CONTROL_PARAM.P_Q_CMD_LIM;
  } else if (rtb_Multiply4_b < -CONTROL_PARAM.P_Q_CMD_LIM) {
    rtb_rate_error_B_radPs_idx_2 = -CONTROL_PARAM.P_Q_CMD_LIM;
  } else {
    rtb_rate_error_B_radPs_idx_2 = rtb_Multiply4_b;
  }
  ...
  if (Controller_U.FMS_Out.ctrl_mode == 2) {
    rtb_Saturation_idx_1 = Controller_U.FMS_Out.p_cmd;
    rtb_Saturation_idx_0 = Controller_U.FMS_Out.q_cmd;
    rtb_DiscreteTimeIntegrator1_b_i = Controller_U.FMS_Out.r_cmd;
  } else if (Controller_U.FMS_Out.ctrl_mode == 6) {
    ...
    if ((Controller_U.FMS_Out.cmd_mask & 1) > 0) {
      ...
      rtb_Saturation_idx_1 = rtb_Add3_j_idx_0 - arm_sin_f32
    ...
    if ((Controller_U.FMS_Out.cmd_mask & 2) > 0) {
      ...
      rtb_Saturation_idx_0 = rtb_Multiply4_b * rtb_DiscreteTimeIntegrator1_b_i *
    ...
    if ((Controller_U.FMS_Out.cmd_mask & 4) > 0) {
      ...
      rtb_DiscreteTimeIntegrator1_b_i = rtb_rate_error_B_radPs_idx_0 *
        rtb_DiscreteTimeIntegrator1_b_i * rtb_Saturation_m - rtb_Multiply4_b *
        rtb_rate_error_B_radPs_idx_2;
    }
    ...
    rtb_Saturation_idx_0 = rtb_Multiply4_b * rtb_DiscreteTimeIntegrator1_b_i *
      rtb_Saturation_m + rtb_rate_error_B_radPs_idx_0 *
      rtb_rate_error_B_radPs_idx_2;
    rtb_DiscreteTimeIntegrator1_b_i = rtb_rate_error_B_radPs_idx_1 *
      rtb_Saturation_m - rtb_Multiply4_b * rtb_rate_error_B_radPs_idx_2;
  }
   ...
   *  Inport: '<Root>/INS_Out'
   */
  rtb_rate_error_B_radPs_idx_0 = rtb_Saturation_idx_1 - Controller_U.INS_Out.p;
  rtb_rate_error_B_radPs_idx_1 = rtb_Saturation_idx_0 - Controller_U.INS_Out.q;
  rtb_rate_error_B_radPs_idx_2 = rtb_DiscreteTimeIntegrator1_b_i -
   ...
   *  Sum: '<S22>/Sum5'
   */
  rtb_Saturation_idx_1 = (Controller_DW.DiscreteTimeIntegrator5_DSTATE[0] -
    Controller_DW.DiscreteTimeIntegrator1_DSTAT_o[0]) * 188.49556F;
  rtb_Saturation_idx_0 = (Controller_DW.DiscreteTimeIntegrator5_DSTATE[1] -
  ...
  if (Controller_U.FMS_Out.status == 3) {
    ...
    if (Controller_U.FMS_Out.reset > 0) {
      ...
      rtb_Multiply4_b = 0.0F;
      rtb_Saturation_m = 0.0F;
    } else {
      rtb_Saturation_d_idx_0 = rtb_Saturation_idx_1;
      rtb_Multiply4_b = rtb_Saturation_idx_0;
      rtb_Saturation_m = rtb_DiscreteTimeIntegrator1_b_i;
    }
    ...
    rtb_Add3_j_idx_0 = CONTROL_PARAM.PITCH_RATE_D * rtb_Multiply4_b;
    rtb_Saturation_m *= CONTROL_PARAM.YAW_RATE_D;
    ...
    if ((Controller_U.FMS_Out.ctrl_mode == 1) || (Controller_U.FMS_Out.ctrl_mode
      ...
      if ((Controller_U.FMS_Out.cmd_mask & 4096) > 0) {
        ...
        rtb_throttle_cmd = (uint16_T)((uint32_T)fmodf(floorf((u0 + 0.5F) *
          1000.0F), 4.2949673E+9F) + 1000U);
      }

      /* End of Switch: '<S58>/Switch' */
    } else {
      if (rtb_Subtract3_i_idx_0 > 0.35F) {
        /* Saturate: '<S59>/Saturation' */
        rtb_Subtract3_i_idx_0 = 0.35F;
      } else if (rtb_Subtract3_i_idx_0 < -0.35F) {
        /* Saturate: '<S59>/Saturation' */
        rtb_Subtract3_i_idx_0 = -0.35F;
      }
       ...
       *  Sum: '<S55>/Sum1'
       */
      rtb_throttle_cmd = (uint16_T)((uint32_T)fmodf(floorf
        ((rtb_Subtract3_i_idx_0 + 0.5F) * 1000.0F), 4.2949673E+9F) + 1000U);
    }
     ...
     *  Sum: '<S16>/Add'
     */
    rtb_Saturation_d_idx_0 += CONTROL_PARAM.ROLL_RATE_P *
      Controller_DW.DiscreteTimeIntegrator5_DSTATE[0] +
      Controller_DW.DiscreteTimeIntegrator_DSTATE_o[0];

    /* Saturate: '<S19>/Saturation' */
    if (rtb_Add3_j_idx_0 > CONTROL_PARAM.RATE_D_MAX) {
      rtb_Add3_j_idx_0 = CONTROL_PARAM.RATE_D_MAX;
    } else if (rtb_Add3_j_idx_0 < CONTROL_PARAM.RATE_D_MIN) {
      rtb_Add3_j_idx_0 = CONTROL_PARAM.RATE_D_MIN;
    }
     ...
     *  Sum: '<S16>/Add'
     */
    rtb_Add3_j_idx_0 += CONTROL_PARAM.PITCH_RATE_P *
      Controller_DW.DiscreteTimeIntegrator5_DSTATE[1] +
      Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1];
    ...
    } else if (rtb_Saturation_m < CONTROL_PARAM.RATE_D_MIN) {
     ...
     *  Sum: '<S16>/Add'
     */
    rtb_Saturation_m += CONTROL_PARAM.YAW_RATE_P *
      Controller_DW.DiscreteTimeIntegrator5_DSTATE[2] +
      Controller_DW.DiscreteTimeIntegrator_DSTATE_o[2];
    ...
    } else if (rtb_Saturation_d_idx_0 < -1.0F) {
      rtb_Saturation_d_idx_0 = -1.0F;
    }

    if (rtb_Add3_j_idx_0 > 1.0F) {
      rtb_Add3_j_idx_0 = 1.0F;
    } else if (rtb_Add3_j_idx_0 < -1.0F) {
      rtb_Add3_j_idx_0 = -1.0F;
    }

    if (rtb_Saturation_m > 1.0F) {
      rtb_Saturation_m = 1.0F;
    } else if (rtb_Saturation_m < -1.0F) {
      rtb_Saturation_m = -1.0F;
    }
    ...
    for (i = 0; i < 4; i++) {
       ...
       *  Sum: '<S6>/Add'
       */
      u0 = fmodf(floorf(((Controller_ConstP.X_Frame_Effective_Matrix_Value[i + 4]
                          * rtb_Add3_j_idx_0 +
                         ...
                         * rtb_Saturation_m) * 1000.0F), 65536.0F);
      u0_0 = (uint16_T)((uint32_T)(u0 < 0.0F ? (int32_T)(uint16_T)-(int16_T)
        (uint16_T)-u0 : (int32_T)(uint16_T)u0) + rtb_throttle_cmd);
      if (u0_0 > 1900) {
  ...
  rtb_Saturation_d_idx_0 = CONTROL_PARAM.ROLL_RATE_I *
    Controller_DW.DiscreteTimeIntegrator5_DSTATE[0];
  rtb_Multiply4_b = CONTROL_PARAM.PITCH_RATE_I *
    Controller_DW.DiscreteTimeIntegrator5_DSTATE[1];
  rtb_Saturation_m = CONTROL_PARAM.YAW_RATE_I *
    Controller_DW.DiscreteTimeIntegrator5_DSTATE[2];
   ...
   *  Sum: '<S45>/Subtract'
   */
  u0 = (sqrtf((8.0F * fabsf(rtb_Subtract3_i_idx_0) + Controller_ConstB.d) *
              Controller_ConstB.d) - Controller_ConstB.d) * 0.5F * (real32_T)i +
    rtb_Add3_j_idx_0;

  /* Signum: '<S45>/Sign1' incorporates:
   *  Signum: '<S45>/Sign'
   *  Sum: '<S45>/Add3'
   */
  rtb_Add = rtb_Subtract3_i_idx_0 + Controller_ConstB.d;

  /* Signum: '<S45>/Sign2' incorporates:
   *  Signum: '<S45>/Sign'
   *  Sum: '<S45>/Subtract1'
   */
  y = rtb_Subtract3_i_idx_0 - Controller_ConstB.d;
   ...
   *  Sum: '<S45>/Subtract2'
   */
  rtb_Subtract3_i_idx_0 = ((rtb_Subtract3_i_idx_0 - u0) + rtb_Add3_j_idx_0) *
    ((real32_T)(i - u) * 0.5F) + u0;

  /* Signum: '<S45>/Sign' */
  if (rtb_Subtract3_i_idx_1 < 0.0F) {
    i = -1;
  } else {
    i = (rtb_Subtract3_i_idx_1 > 0.0F);
  }
   ...
   *  Sum: '<S45>/Subtract'
   */
  u0 = (sqrtf((8.0F * fabsf(rtb_Subtract3_i_idx_1) + Controller_ConstB.d) *
              Controller_ConstB.d) - Controller_ConstB.d) * 0.5F * (real32_T)i +
    rtb_Add3_j_idx_1;
   ...
   *  Sum: '<S45>/Add3'
   */
  rtb_Add = rtb_Subtract3_i_idx_1 + Controller_ConstB.d;

  /* Signum: '<S45>/Sign2' incorporates:
   *  Signum: '<S45>/Sign'
   *  Sum: '<S45>/Subtract1'
   */
  y = rtb_Subtract3_i_idx_1 - Controller_ConstB.d;
   ...
   *  Sum: '<S45>/Subtract2'
   */
  u0 += ((rtb_Subtract3_i_idx_1 - u0) + rtb_Add3_j_idx_1) * ((real32_T)(i - u) *
    0.5F);
   ...
   */
  rtb_Add3_j_idx_0 = Controller_DW.Integrator_DSTATE_p * 0.05F;
   ...
   *  Sum: '<S63>/Subtract'
   */
  rtb_Add3_j_idx_1 = (Controller_DW.Integrator1_DSTATE -
                      Controller_U.FMS_Out.w_cmd) + rtb_Add3_j_idx_0;

  /* Signum: '<S64>/Sign' */
  if (rtb_Add3_j_idx_1 < 0.0F) {
    i = -1;
  } else {
    i = (rtb_Add3_j_idx_1 > 0.0F);
  }
   ...
   *  Sum: '<S64>/Subtract'
   */
  rtb_Subtract3_i_idx_1 = (sqrtf((8.0F * fabsf(rtb_Add3_j_idx_1) +
    Controller_ConstB.d_n) * Controller_ConstB.d_n) - Controller_ConstB.d_n) *
    0.5F * (real32_T)i + rtb_Add3_j_idx_0;

  /* Sum: '<S64>/Add3' */
  rtb_Add = rtb_Add3_j_idx_1 + Controller_ConstB.d_n;

  /* Sum: '<S64>/Subtract1' */
  y = rtb_Add3_j_idx_1 - Controller_ConstB.d_n;
   ...
   *  Sum: '<S64>/Subtract2'
   */
  rtb_Subtract3_i_idx_1 += ((rtb_Add3_j_idx_1 - rtb_Subtract3_i_idx_1) +
    rtb_Add3_j_idx_0) * ((real32_T)(i - u) * 0.5F);
  ...
  /* Update for DiscreteIntegrator: '<S20>/Discrete-Time Integrator' */
  Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1] += 0.002F * rtb_Multiply4_b;
  if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1] >=
      CONTROL_PARAM.RATE_I_MAX) {
    Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1] = CONTROL_PARAM.RATE_I_MAX;
  } else if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1] <=
  ...
  /* Update for DiscreteIntegrator: '<S20>/Discrete-Time Integrator' */
  Controller_DW.DiscreteTimeIntegrator_DSTATE_o[2] += 0.002F * rtb_Saturation_m;
  if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[2] >=
      CONTROL_PARAM.RATE_I_MAX) {
    Controller_DW.DiscreteTimeIntegrator_DSTATE_o[2] = CONTROL_PARAM.RATE_I_MAX;
  } else if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[2] <=
  ...
  if (rtb_Subtract3_i_idx_0 < 0.0F) {
    ...
    rtb_Saturation_1 = (rtb_Subtract3_i_idx_0 > 0.0F);
  }
  ...
  if (rtb_Subtract3_i_idx_0 < 0.0F) {
    ...
    rtb_Saturation_2 = (rtb_Subtract3_i_idx_0 > 0.0F);
  }
   ...
   *  Sum: '<S45>/Subtract6'
   */
  Controller_DW.Integrator_DSTATE[0] += ((rtb_Subtract3_i_idx_0 /
    Controller_ConstB.d - (real32_T)rtb_Saturation_1) * Controller_ConstB.Gain4 *
    ((real32_T)(i - u) * 0.5F) - (real32_T)rtb_Saturation_2 * 58.836F) * 0.002F;

  /* Signum: '<S45>/Sign3' incorporates:
   *  Sum: '<S45>/Add6'
   */
  rtb_Add = u0 + Controller_ConstB.d;

  /* Signum: '<S45>/Sign4' incorporates:
   *  Sum: '<S45>/Subtract3'
   */
  y = u0 - Controller_ConstB.d;

  /* Signum: '<S45>/Sign5' */
  if (u0 < 0.0F) {
    rtb_Saturation_1 = -1;
  } else {
    rtb_Saturation_1 = (u0 > 0.0F);
  }
   ...
   *  Sum: '<S45>/Subtract6'
   */
  Controller_DW.Integrator_DSTATE[1] += ((u0 / Controller_ConstB.d - (real32_T)
    rtb_Saturation_1) * Controller_ConstB.Gain4 * ((real32_T)(i - u) * 0.5F) -
    (real32_T)rtb_Saturation_2 * 58.836F) * 0.002F;
  ...
  if (rtb_Subtract3_i_idx_1 < 0.0F) {
    ...
    /* Signum: '<S64>/Sign6' */
    rtb_Saturation_1 = (rtb_Subtract3_i_idx_1 > 0.0F);
  }

  /* Sum: '<S64>/Add6' */
  rtb_Add = rtb_Subtract3_i_idx_1 + Controller_ConstB.d_n;

  /* Sum: '<S64>/Subtract3' */
  y = rtb_Subtract3_i_idx_1 - Controller_ConstB.d_n;
   ...
   *  Sum: '<S64>/Subtract6'
   */
  Controller_DW.Integrator_DSTATE_p += ((rtb_Subtract3_i_idx_1 /
    Controller_ConstB.d_n - (real32_T)rtb_Saturation_1) *
    Controller_ConstB.Gain4_k * ((real32_T)(i - u) * 0.5F) - (real32_T)
    rtb_Saturation_1 * 78.448F) * 0.002F;
}
...
void Controller_init(void)
{
  ...
  Controller_DW.DiscreteTimeIntegrator_DSTATE_o[0] = Controller_ConstB.Constant
    [0];
  if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[0] >=
      CONTROL_PARAM.RATE_I_MAX) {
    Controller_DW.DiscreteTimeIntegrator_DSTATE_o[0] = CONTROL_PARAM.RATE_I_MAX;
  ...
  Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1] = Controller_ConstB.Constant
    [1];
  if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1] >=
      CONTROL_PARAM.RATE_I_MAX) {
    Controller_DW.DiscreteTimeIntegrator_DSTATE_o[1] = CONTROL_PARAM.RATE_I_MAX;
  ...
  Controller_DW.DiscreteTimeIntegrator_DSTATE_o[2] = Controller_ConstB.Constant
    [2];
  if (Controller_DW.DiscreteTimeIntegrator_DSTATE_o[2] >=
      CONTROL_PARAM.RATE_I_MAX) {
    Controller_DW.DiscreteTimeIntegrator_DSTATE_o[2] = CONTROL_PARAM.RATE_I_MAX;
