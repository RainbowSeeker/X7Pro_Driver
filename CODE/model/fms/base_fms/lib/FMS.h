...
typedef struct {
  ...
  Msg_FMS_Cmd Msg[11];                 /* '<Root>/FMS State Machine' */
  Queue_FMS_Cmd Queue;                 /* '<Root>/FMS State Machine' */
  ...
  int32_T durationCounter_1;           /* '<Root>/FMS State Machine' */
  int32_T durationCounter_1_j;         /* '<Root>/FMS State Machine' */
  int32_T durationCounter_1_f;         /* '<Root>/FMS State Machine' */
  int32_T durationCounter_2;           /* '<Root>/FMS State Machine' */
  int32_T durationCounter_1_d;         /* '<Root>/FMS State Machine' */
  int32_T durationCounter_1_a;         /* '<Root>/FMS State Machine' */
  int32_T durationCounter_2_l;         /* '<Root>/FMS State Machine' */
  ...
  uint16_T temporalCounter_i1_h;       /* '<S100>/Motion State' */
  ...
  uint8_T temporalCounter_i1_j;        /* '<S320>/Motion State' */
  ...
  boolean_T icLoad_k;                  /* '<S144>/Delay' */
  boolean_T icLoad_o;                  /* '<S371>/Delay' */
  boolean_T icLoad_c;                  /* '<S351>/Delay' */
  boolean_T icLoad_j;                  /* '<S352>/Delay' */
...
typedef struct {
  ...
  const real32_T VectorConcatenate3_e[3];/* '<S222>/Vector Concatenate3' */
  const real32_T VectorConcatenate3_o[3];/* '<S224>/Vector Concatenate3' */
  const real32_T VectorConcatenate3_n[3];/* '<S284>/Vector Concatenate3' */
  const real32_T VectorConcatenate3_i[3];/* '<S287>/Vector Concatenate3' */
  const real32_T VectorConcatenate3_ny[3];/* '<S290>/Vector Concatenate3' */
  const real32_T VectorConcatenate3_e0[3];/* '<S291>/Vector Concatenate3' */
  ...
  ConstB_VehicleArmAutoMissionL_T VehicleArmAutoMissionLLA2FLAT;
                                  /* '<S4>/Vehicle.Arm.Auto.Mission.LLA2FLAT' */
