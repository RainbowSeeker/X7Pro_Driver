...
#define FINSH_GET32(x)    (ubase_t)(*(x)) | ((ubase_t)*((x)+1) << 8) | \
    ((ubase_t)*((x)+2) << 16) | ((ubase_t)*((x)+3) << 24)
...
#define FINSH_SET32(x, v)                                       \
    do                                                          \
    {                                                           \
        *(x)     = (uint32_t)(v)  & 0x000000ff;              \
        (*((x)+1)) = ((uint32_t)(v) >> 8) & 0x000000ff;      \
        (*((x)+2)) = ((uint32_t)(v) >> 16) & 0x000000ff;     \
        (*((x)+3)) = ((uint32_t)(v) >> 24);                  \
    } while ( 0 )
