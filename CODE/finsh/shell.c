...
// *
// * @return result, RT_EOK on OK, -E_RROR on the new password length is less than
// *  FINSH_PASSWORD_MIN or greater than FINSH_PASSWORD_MAX
// */
//rt_err_t finsh_set_password(const char *password) {
//    ubase_t level;
//    size_t pw_len = rt_strlen(password);
//
...
//#endif
//
//    // printf(FINSH_PROMPT);    /* do not print pompt in the beginning */
//
//    while (1)
//    {
//        ch = finsh_getchar();
