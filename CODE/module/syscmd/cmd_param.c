...
static int set(int argc, struct optparse options)
{
    ...
    if (arg_c == 2) {
        ...
        if (param_set_str_val_by_name(param_name, value) != E_OK) {
        ...
        if (param_set_str_val_by_full_name(group_name, param_name, value) != E_OK) {
