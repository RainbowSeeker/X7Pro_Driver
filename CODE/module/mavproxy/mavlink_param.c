...
err_t send_mavparam_by_name(char* name)
{
...
err_t send_mavparam_by_index(int16_t index)
{
...
err_t mavlink_param_set(const char* name, float val)
{
    err_t err;
    param_t* param;
    int8_t i8val;
...
err_t mavlink_param_send(const param_t* param)
{
    mavlink_message_t msg;
