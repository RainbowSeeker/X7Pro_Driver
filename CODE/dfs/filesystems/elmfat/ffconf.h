...
#ifdef DFS_ELM_CODE_PAGE
#    define FF_CODE_PAGE	DFS_ELM_CODE_PAGE
#else
...
#define FF_LFN_UNICODE	DFS_ELM_LFN_UNICODE	/* 0:ANSI/OEM or 1:Unicode */
#else
...
#ifdef DFS_ELM_DRIVES
#define FF_VOLUMES DFS_ELM_DRIVES
#else
#define FF_VOLUMES	1
#endif
