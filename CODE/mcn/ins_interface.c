...
static struct INS_Handler {
    mcn_node_t *imu_sub_node_t;
    mcn_node_t *mag_sub_node_t;
    mcn_node_t *baro_sub_node_t;
    mcn_node_t *gps_sub_node_t;
    mcn_node_t *rf_sub_node_t;
    mcn_node_t *optflow_sub_node_t;
    mcn_node_t *airspeed_sub_node_t;
...
static int ins_output_echo(void* param)
{
    ...
    mcn_copy_from_hub((mcn_hub_t *)param, &ins_out);
#define BIT(u, n) (u & (1 << n))
    printf("timestamp:%u\n", ins_out.timestamp);
