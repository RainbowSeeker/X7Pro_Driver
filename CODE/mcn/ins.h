...
typedef struct {
    float GPS_HOR_Q_BIAS;
    float GPS_HOR_Q_SCALE;
    float GPS_VER_Q_BIAS;
    float GPS_VER_Q_SCALE;
    float GPS_VEL_Q_BIAS;
    float GPS_VEL_Q_SCALE;
    float ATT_GAIN;
    float HEADING_GAIN;
    float MAG_GAIN;
    float BIAS_G_GAIN;
...
typedef struct {
    double DataTypeConversion;           /* '<S349>/Data Type Conversion' */
    double DataTypeConversion1;          /* '<S349>/Data Type Conversion1' */
    double Multiply2;                    /* '<S365>/Multiply2' */
    double Rm;                           /* '<S365>/Product3' */
    float Divide;                     /* '<S335>/Divide' */
    float Merge;                      /* '<S245>/Merge' */
    float Merge_e;                    /* '<S246>/Merge' */
    float Merge_n[2];                 /* '<S204>/Merge' */
    float rf_height_bias;             /* '<S237>/Switch' */
    float Sum1[3];                    /* '<S231>/Sum1' */
    float Sum1_p[3];                  /* '<S222>/Sum1' */
    float Sum1_pu[3];                 /* '<S213>/Sum1' */
    float Saturation;                 /* '<S213>/Saturation' */
    float DataTypeConversion_n[2];    /* '<S205>/Data Type Conversion' */
    float Sum1_f[6];                  /* '<S194>/Sum1' */
    float Sum1_o[6];                  /* '<S184>/Sum1' */
    float Merge_l[4];                 /* '<S129>/Merge' */
    float OutportBufferForquat_0[4];  /* '<S113>/DCM To Quaternion' */
    float Integrator[3];              /* '<S91>/Integrator' */
} BlockIO_INS_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
    double Delay1_DSTATE;                /* '<S318>/Delay1' */
    double Delay_DSTATE[2];              /* '<S319>/Delay' */
    double Delay1_DSTATE_o[2];           /* '<S319>/Delay1' */
    float Delay_2_DSTATE;             /* '<Root>/Delay' */
    float Delay_3_DSTATE;             /* '<Root>/Delay' */
    float Delay_8_DSTATE[9];          /* '<Root>/Delay' */
    float DiscreteTimeIntegrator5_DSTATE[2];/* '<S394>/Discrete-Time Integrator5' */
    float DiscreteTimeIntegrator_DSTATE;/* '<S382>/Discrete-Time Integrator' */
    float DiscreteTimeIntegrator1_DSTATE;/* '<S382>/Discrete-Time Integrator1' */
    float DiscreteTimeIntegrator1_DSTAT_g;/* '<S362>/Discrete-Time Integrator1' */
    float DiscreteTimeIntegrator1_DSTAT_m;/* '<S363>/Discrete-Time Integrator1' */
    float DiscreteTimeIntegrator_DSTATE_k;/* '<S362>/Discrete-Time Integrator' */
    float DiscreteTimeIntegrator_DSTATE_l;/* '<S363>/Discrete-Time Integrator' */
    float Delay_DSTATE_d;             /* '<S335>/Delay' */
    float Delay_4_DSTATE;             /* '<S56>/Delay' */
    float Delay_5_DSTATE;             /* '<S56>/Delay' */
    float Delay_6_DSTATE;             /* '<S56>/Delay' */
    float DiscreteTimeIntegrator_DSTATE_f;/* '<S272>/Discrete-Time Integrator' */
    float DiscreteTimeIntegrator1_DSTAT_h;/* '<S272>/Discrete-Time Integrator1' */
    float DiscreteTimeIntegrator_DSTATE_b;/* '<S287>/Discrete-Time Integrator' */
    float DiscreteTimeIntegrator_DSTATE_c;/* '<S299>/Discrete-Time Integrator' */
    float DiscreteTimeIntegrator_DSTATE_n;/* '<S286>/Discrete-Time Integrator' */
    float DiscreteTimeIntegrator_DSTATE_h;/* '<S298>/Discrete-Time Integrator' */
    float DiscreteTimeIntegrator_DSTAT_k3;/* '<S300>/Discrete-Time Integrator' */
    float Delay_DSTATE_b[3];          /* '<S242>/Delay' */
    float Delay_DSTATE_l[6];          /* '<S200>/Delay' */
    float h_delay_DSTATE[3];          /* '<S235>/h_delay' */
    float Delay_DSTATE_o;             /* '<S240>/Delay' */
    float h_delay_DSTATE_l[75];       /* '<S226>/h_delay' */
    float vd_delay_DSTATE[50];        /* '<S226>/vd_delay' */
    float Delay_DSTATE_dr[3];         /* '<S215>/Delay' */
    float x_delay_DSTATE[5];          /* '<S217>/x_delay' */
    float Delay_DSTATE_h;             /* '<S219>/Delay' */
    float vn_delay_DSTATE[3];         /* '<S198>/vn_delay' */
    float ve_delay_DSTATE[3];         /* '<S198>/ve_delay' */
    float x_delay_DSTATE_k[75];       /* '<S188>/x_delay' */
    float x_delay1_DSTATE[75];        /* '<S188>/x_delay1' */
    float vn_delay_DSTATE_n[50];      /* '<S188>/vn_delay' */
    float vn_delay1_DSTATE[50];       /* '<S188>/vn_delay1' */
    float DiscreteTimeIntegrator5_DSTAT_o[2];/* '<S165>/Discrete-Time Integrator5' */
    float DiscreteTimeIntegrator5_DSTAT_m;/* '<S163>/Discrete-Time Integrator5' */
    float DiscreteTimeIntegrator5_DSTA_ow;/* '<S164>/Discrete-Time Integrator5' */
    float Delay_7_DSTATE[9];          /* '<S57>/Delay' */
    float Delay_8_DSTATE_l[9];        /* '<S57>/Delay' */
    float DiscreteTimeIntegrator_DSTAT_kk[4];/* '<S97>/Discrete-Time Integrator' */
    float DiscreteTimeIntegrator2_DSTATE[3];/* '<S98>/Discrete-Time Integrator2' */
    float DiscreteTimeIntegrator1_DSTAT_o[3];/* '<S88>/Discrete-Time Integrator1' */
    float Delay_DSTATE_lv[600];       /* '<S86>/Delay' */
    float DiscreteTimeIntegrator_DSTAT_lq[3];/* '<S88>/Discrete-Time Integrator' */
    float DiscreteTimeIntegrator1_DSTAT_b[3];/* '<S95>/Discrete-Time Integrator1' */
    float DiscreteTimeIntegrator_DSTAT_ce[3];/* '<S95>/Discrete-Time Integrator' */
    float Integrator_DSTATE[3];       /* '<S91>/Integrator' */
    float Integrator1_DSTATE[3];      /* '<S91>/Integrator1' */
    float DiscreteTimeIntegrator_DSTAT_bo;/* '<S12>/Discrete-Time Integrator' */
    float DiscreteTimeIntegrator_DSTAT_hi;/* '<S15>/Discrete-Time Integrator' */
    float DiscreteTimeIntegrator_DSTAT_b3;/* '<S17>/Discrete-Time Integrator' */
    float DiscreteTimeIntegrator_DSTAT_ca;/* '<S11>/Discrete-Time Integrator' */
    float DiscreteTimeIntegrator_DSTATE_e;/* '<S13>/Discrete-Time Integrator' */
    float DiscreteTimeIntegrator_DSTAT_kg;/* '<S14>/Discrete-Time Integrator' */
    float DiscreteTimeIntegrator_DSTATE_a;/* '<S16>/Discrete-Time Integrator' */
    ...
    float Memory_PreviousInput;       /* '<S237>/Memory' */
    float Memory_PreviousInput_f[3];  /* '<S233>/Memory' */
    float Memory_PreviousInput_b;     /* '<S228>/Memory' */
    float Memory_PreviousInput_e[3];  /* '<S224>/Memory' */
    float Memory_PreviousInput_n[6];  /* '<S196>/Memory' */
    float Memory_PreviousInput_d[2];  /* '<S191>/Memory' */
    float Memory_PreviousInput_h[6];  /* '<S186>/Memory' */
    ...
    uint8_t Delay_DSTATE_c;            /* '<S397>/Delay' */
    uint8_t DelayInput1_DSTATE_o;      /* '<S280>/Delay Input1' */
    uint8_t DelayInput1_DSTATE_hg;     /* '<S296>/Delay Input1' */
    uint8_t Delay_DSTATE_k;            /* '<S287>/Delay' */
    uint8_t DelayInput1_DSTATE_j;      /* '<S281>/Delay Input1' */
    uint8_t DelayInput1_DSTATE_p;      /* '<S309>/Delay Input1' */
    uint8_t Delay_DSTATE_k4;           /* '<S299>/Delay' */
    uint8_t Delay_DSTATE_ng;           /* '<S286>/Delay' */
    uint8_t DelayInput1_DSTATE_kh;     /* '<S291>/Delay Input1' */
    uint8_t Delay_DSTATE_c1;           /* '<S298>/Delay' */
    uint8_t DelayInput1_DSTATE_ch;     /* '<S304>/Delay Input1' */
    uint8_t Delay_DSTATE_n2;           /* '<S300>/Delay' */
    uint8_t DelayInput1_DSTATE_jx;     /* '<S314>/Delay Input1' */
    uint8_t DelayInput1_DSTATE_dp;     /* '<S320>/Delay Input1' */
    uint8_t DelayInput1_DSTATE_mw;     /* '<S322>/Delay Input1' */
    uint8_t DelayInput1_DSTATE_d2;     /* '<S239>/Delay Input1' */
    uint8_t DelayInput1_DSTATE_ib;     /* '<S230>/Delay Input1' */
    uint8_t DelayInput1_DSTATE_f;      /* '<S221>/Delay Input1' */
    uint8_t DelayInput1_DSTATE_gn;     /* '<S193>/Delay Input1' */
    uint8_t DelayInput1_DSTATE_pr;     /* '<S117>/Delay Input1' */
    uint8_t DelayInput1_DSTATE_mm;     /* '<S124>/Delay Input1' */
    uint8_t DelayInput1_DSTATE_ff;     /* '<S90>/Delay Input1' */
    uint8_t Delay_DSTATE_bn;           /* '<S12>/Delay' */
    uint8_t Delay_DSTATE_cx;           /* '<S15>/Delay' */
    uint8_t Delay_DSTATE_l0;           /* '<S17>/Delay' */
    uint8_t Delay_DSTATE_cn;           /* '<S11>/Delay' */
    uint8_t Delay_DSTATE_p;            /* '<S13>/Delay' */
    uint8_t Delay_DSTATE_db;           /* '<S14>/Delay' */
    uint8_t Delay_DSTATE_ly;           /* '<S16>/Delay' */
    uint8_t DelayInput1_DSTATE_dx;     /* '<S21>/Delay Input1' */
    uint8_t DelayInput1_DSTATE_mu;     /* '<S26>/Delay Input1' */
    uint8_t DelayInput1_DSTATE_dq;     /* '<S31>/Delay Input1' */
    uint8_t DelayInput1_DSTATE_f4;     /* '<S36>/Delay Input1' */
    uint8_t DelayInput1_DSTATE_ng;     /* '<S41>/Delay Input1' */
    uint8_t DelayInput1_DSTATE_dql;    /* '<S46>/Delay Input1' */
    uint8_t DelayInput1_DSTATE_fq;     /* '<S51>/Delay Input1' */
    ...
    uint8_t Relay_Mode;                /* '<S393>/Relay' */
    uint8_t Relay_Mode_n;              /* '<S274>/Relay' */
    uint8_t Relay1_Mode;               /* '<S274>/Relay1' */
    uint8_t Relay_Mode_n5;             /* '<S114>/Relay' */
    uint8_t Relay_Mode_nf;             /* '<S92>/Relay' */
    uint8_t Relay1_Mode_l;             /* '<S71>/Relay1' */
    uint8_t Relay1_Mode_j;             /* '<S9>/Relay1' */
    uint8_t Reference_Height_MODE;     /* '<S333>/Reference_Height' */
    uint8_t Rangefinder_Correct_MODE;  /* '<S212>/Rangefinder_Correct' */
    uint8_t GPS_Correct_MODE;          /* '<S211>/GPS_Correct' */
    uint8_t Baro_Correct_MODE;         /* '<S210>/Baro_Correct' */
    uint8_t OptFlow_Correct_MODE;      /* '<S183>/OptFlow_Correct' */
    uint8_t GPS_Correct_MODE_o;        /* '<S182>/GPS_Correct' */
    uint8_t GPS_Meas_Acc_MODE;         /* '<S87>/GPS_Meas_Acc' */
} D_Work_INS_T;

/* Zero-crossing (trigger) state */
typedef struct {
    uint8_t WGS84_Model_Trig_ZCE;     /* '<S326>/WGS84_Model' */
    uint8_t h_delay_Reset_ZCE;        /* '<S235>/h_delay' */
    uint8_t h_delay_Reset_ZCE_m;      /* '<S226>/h_delay' */
    uint8_t vd_delay_Reset_ZCE;       /* '<S226>/vd_delay' */
    uint8_t x_delay_Reset_ZCE;        /* '<S217>/x_delay' */
    uint8_t vn_delay_Reset_ZCE;       /* '<S198>/vn_delay' */
    uint8_t ve_delay_Reset_ZCE;       /* '<S198>/ve_delay' */
    uint8_t x_delay_Reset_ZCE_b;      /* '<S188>/x_delay' */
    uint8_t x_delay1_Reset_ZCE;       /* '<S188>/x_delay1' */
    uint8_t vn_delay_Reset_ZCE_p;     /* '<S188>/vn_delay' */
    uint8_t vn_delay1_Reset_ZCE;      /* '<S188>/vn_delay1' */
...
struct Parameters_INS_T_ {
    struct_Gsh1YUlqR57cYRpVuxG74E INS_CONST;/* Variable: INS_CONST
                                           ...
                                           *   '<S243>/Constant1'
                                           */
    double WMM_LUT_resolution;           /* Mask Parameter: WMM_LUT_resolution
                                        * Referenced by: '<S378>/rad_to_index'
                                        */
    int32_t valid_samples_const;         /* Mask Parameter: valid_samples_const
                                        * Referenced by: '<S359>/Constant'
                                        */
    float Sensor_Valid_acc_max;       /* Mask Parameter: Sensor_Valid_acc_max
                                        * Referenced by: '<S371>/Upper Limit'
                                        */
    float Sensor_Valid_acc_min;       /* Mask Parameter: Sensor_Valid_acc_min
                                        * Referenced by: '<S371>/Lower Limit'
                                        */
    float CompareToConstant_const;    /* Mask Parameter: CompareToConstant_const
                                        * Referenced by: '<S94>/Constant'
                                        */
    float CompareToConstant_const_p;  /* Mask Parameter: CompareToConstant_const_p
                                        * Referenced by: '<S115>/Constant'
                                        */
    float CompareToConstant1_const;   /* Mask Parameter: CompareToConstant1_const
                                        * Referenced by: '<S116>/Constant'
                                        */
    float CompareToConstant_const_n;  /* Mask Parameter: CompareToConstant_const_n
                                        * Referenced by: '<S241>/Constant'
                                        */
    float Sensor_Valid_gyr_max;       /* Mask Parameter: Sensor_Valid_gyr_max
                                        * Referenced by: '<S372>/Upper Limit'
                                        */
    float Sensor_Valid_gyr_min;       /* Mask Parameter: Sensor_Valid_gyr_min
                                        * Referenced by: '<S372>/Lower Limit'
                                        */
    float IntervalTest_lowlimit;      /* Mask Parameter: IntervalTest_lowlimit
                                        * Referenced by: '<S118>/Lower Limit'
                                        */
    float Sensor_Valid_mag_max;       /* Mask Parameter: Sensor_Valid_mag_max
                                        * Referenced by: '<S391>/Upper Limit'
                                        */
    float Sensor_Valid_mag_min;       /* Mask Parameter: Sensor_Valid_mag_min
                                        * Referenced by: '<S391>/Lower Limit'
                                        */
    float Sensor_Valid_max_alt;       /* Mask Parameter: Sensor_Valid_max_alt
                                        * Referenced by: '<S406>/Upper Limit'
                                        */
    float Sensor_Valid_max_pressure;  /* Mask Parameter: Sensor_Valid_max_pressure
                                        * Referenced by: '<S343>/Upper Limit'
                                        */
    float Sensor_Valid_max_temp;      /* Mask Parameter: Sensor_Valid_max_temp
                                        * Referenced by: '<S344>/Upper Limit'
                                        */
    float Sensor_Valid_max_vel;       /* Mask Parameter: Sensor_Valid_max_vel
                                        * Referenced by:
                                        *   '<S398>/Upper Limit'
                                        *   '<S399>/Upper Limit'
                                        */
    float Sensor_Valid_min_alt;       /* Mask Parameter: Sensor_Valid_min_alt
                                        * Referenced by: '<S406>/Lower Limit'
                                        */
    float Sensor_Valid_min_pressure;  /* Mask Parameter: Sensor_Valid_min_pressure
                                        * Referenced by: '<S343>/Lower Limit'
                                        */
    float Sensor_Valid_min_temp;      /* Mask Parameter: Sensor_Valid_min_temp
                                        * Referenced by: '<S344>/Lower Limit'
                                        */
    float Sensor_Valid_min_vel;       /* Mask Parameter: Sensor_Valid_min_vel
                                        * Referenced by:
                                        *   '<S398>/Lower Limit'
                                        *   '<S399>/Lower Limit'
                                        */
    float valid_check2_time_out;      /* Mask Parameter: valid_check2_time_out
                                        * Referenced by: '<S23>/Constant'
                                        */
    float valid_check5_time_out;      /* Mask Parameter: valid_check5_time_out
                                        * Referenced by: '<S38>/Constant'
                                        */
    float valid_check8_time_out;      /* Mask Parameter: valid_check8_time_out
                                        * Referenced by: '<S48>/Constant'
                                        */
    float valid_check1_time_out;      /* Mask Parameter: valid_check1_time_out
                                        * Referenced by: '<S18>/Constant'
                                        */
    float valid_check3_time_out;      /* Mask Parameter: valid_check3_time_out
                                        * Referenced by: '<S28>/Constant'
                                        */
    float valid_check4_time_out;      /* Mask Parameter: valid_check4_time_out
                                        * Referenced by: '<S33>/Constant'
                                        */
    float valid_check6_time_out;      /* Mask Parameter: valid_check6_time_out
                                        * Referenced by: '<S43>/Constant'
                                        */
    float valid_hold1_time_out;       /* Mask Parameter: valid_hold1_time_out
                                        * Referenced by: '<S293>/Constant'
                                        */
    float valid_hold1_time_out_m;     /* Mask Parameter: valid_hold1_time_out_m
                                        * Referenced by: '<S306>/Constant'
                                        */
    float valid_hold_time_out;        /* Mask Parameter: valid_hold_time_out
                                        * Referenced by: '<S288>/Constant'
                                        */
    float valid_hold_time_out_d;      /* Mask Parameter: valid_hold_time_out_d
                                        * Referenced by: '<S301>/Constant'
                                        */
    float valid_hold2_time_out;       /* Mask Parameter: valid_hold2_time_out
                                        * Referenced by: '<S311>/Constant'
                                        */
    float IntervalTest_uplimit;       /* Mask Parameter: IntervalTest_uplimit
    ...
    uint8_t CompareToConstant1_const_m;/* Mask Parameter: CompareToConstant1_const_m
                                        ...
                                        */
    uint8_t CompareToConstant1_const_j;/* Mask Parameter: CompareToConstant1_const_j
                                        * Referenced by: '<S39>/Constant'
                                        */
    uint8_t CompareToConstant1_const_g;/* Mask Parameter: CompareToConstant1_const_g
                                        * Referenced by: '<S49>/Constant'
                                        */
    uint8_t CompareToConstant1_const_e;/* Mask Parameter: CompareToConstant1_const_e
                                        * Referenced by: '<S19>/Constant'
                                        */
    uint8_t CompareToConstant1_const_ei;/* Mask Parameter: CompareToConstant1_const_ei
                                         * Referenced by: '<S29>/Constant'
                                         */
    uint8_t CompareToConstant1_const_ec;/* Mask Parameter: CompareToConstant1_const_ec
                                         * Referenced by: '<S34>/Constant'
                                         */
    uint8_t CompareToConstant1_const_em;/* Mask Parameter: CompareToConstant1_const_em
                                         * Referenced by: '<S44>/Constant'
                                         */
    uint8_t CompareToConstant2_const;  /* Mask Parameter: CompareToConstant2_const
                                        * Referenced by: '<S20>/Constant'
                                        */
    uint8_t CompareToConstant2_const_c;/* Mask Parameter: CompareToConstant2_const_c
                                        * Referenced by: '<S25>/Constant'
                                        */
    uint8_t CompareToConstant2_const_n;/* Mask Parameter: CompareToConstant2_const_n
                                        * Referenced by: '<S30>/Constant'
                                        */
    uint8_t CompareToConstant2_const_b;/* Mask Parameter: CompareToConstant2_const_b
                                        * Referenced by: '<S35>/Constant'
                                        */
    uint8_t CompareToConstant2_const_i;/* Mask Parameter: CompareToConstant2_const_i
                                        * Referenced by: '<S40>/Constant'
                                        */
    uint8_t CompareToConstant2_const_l;/* Mask Parameter: CompareToConstant2_const_l
                                        * Referenced by: '<S45>/Constant'
                                        */
    uint8_t CompareToConstant2_const_i1;/* Mask Parameter: CompareToConstant2_const_i1
                                         * Referenced by: '<S50>/Constant'
                                         */
    uint8_t CompareToConstant1_const_i;/* Mask Parameter: CompareToConstant1_const_i
                                        * Referenced by: '<S294>/Constant'
                                        */
    uint8_t CompareToConstant2_const_j;/* Mask Parameter: CompareToConstant2_const_j
                                        * Referenced by: '<S295>/Constant'
                                        */
    uint8_t CompareToConstant1_const_a;/* Mask Parameter: CompareToConstant1_const_a
                                        * Referenced by: '<S307>/Constant'
                                        */
    uint8_t CompareToConstant2_const_d;/* Mask Parameter: CompareToConstant2_const_d
                                        * Referenced by: '<S308>/Constant'
                                        */
    uint8_t CompareToConstant1_const_h;/* Mask Parameter: CompareToConstant1_const_h
                                        * Referenced by: '<S289>/Constant'
                                        */
    uint8_t CompareToConstant2_const_a;/* Mask Parameter: CompareToConstant2_const_a
                                        * Referenced by: '<S290>/Constant'
                                        */
    uint8_t CompareToConstant1_const_hv;/* Mask Parameter: CompareToConstant1_const_hv
                                         * Referenced by: '<S302>/Constant'
                                         */
    uint8_t CompareToConstant2_const_dj;/* Mask Parameter: CompareToConstant2_const_dj
    ...
    uint8_t CompareToConstant1_const_l;/* Mask Parameter: CompareToConstant1_const_l
                                        ...
                                        */
    uint8_t CompareToConstant2_const_h;/* Mask Parameter: CompareToConstant2_const_h
    ...
    uint8_t DetectRisePositive_vinit;  /* Mask Parameter: DetectRisePositive_vinit
                                        ...
                                        */
    uint8_t DetectRisePositive_vinit_c;/* Mask Parameter: DetectRisePositive_vinit_c
                                        * Referenced by: '<S26>/Delay Input1'
                                        */
    uint8_t DetectRisePositive_vinit_m;/* Mask Parameter: DetectRisePositive_vinit_m
                                        * Referenced by: '<S31>/Delay Input1'
                                        */
    uint8_t DetectRisePositive_vinit_k;/* Mask Parameter: DetectRisePositive_vinit_k
                                        * Referenced by: '<S36>/Delay Input1'
                                        */
    uint8_t DetectRisePositive_vinit_a;/* Mask Parameter: DetectRisePositive_vinit_a
                                        * Referenced by: '<S41>/Delay Input1'
                                        */
    uint8_t DetectRisePositive_vinit_f;/* Mask Parameter: DetectRisePositive_vinit_f
                                        * Referenced by: '<S46>/Delay Input1'
                                        */
    uint8_t DetectRisePositive_vinit_l;/* Mask Parameter: DetectRisePositive_vinit_l
                                        * Referenced by: '<S51>/Delay Input1'
                                        */
    uint8_t DetectIncrease_vinit;      /* Mask Parameter: DetectIncrease_vinit
                                        * Referenced by: '<S90>/Delay Input1'
                                        */
    uint8_t DetectRisePositive_vinit_fc;/* Mask Parameter: DetectRisePositive_vinit_fc
                                         * Referenced by: '<S117>/Delay Input1'
                                         */
    uint8_t DetectRisePositive1_vinit; /* Mask Parameter: DetectRisePositive1_vinit
                                        * Referenced by: '<S124>/Delay Input1'
                                        */
    uint8_t DetectIncrease_vinit_p;    /* Mask Parameter: DetectIncrease_vinit_p
                                        * Referenced by: '<S193>/Delay Input1'
                                        */
    uint8_t DetectIncrease_vinit_c;    /* Mask Parameter: DetectIncrease_vinit_c
                                        * Referenced by: '<S221>/Delay Input1'
                                        */
    uint8_t DetectIncrease_vinit_j;    /* Mask Parameter: DetectIncrease_vinit_j
                                        * Referenced by: '<S230>/Delay Input1'
                                        */
    uint8_t DetectIncrease_vinit_g;    /* Mask Parameter: DetectIncrease_vinit_g
                                        * Referenced by: '<S239>/Delay Input1'
                                        */
    uint8_t DetectRisePositive_vinit_me;/* Mask Parameter: DetectRisePositive_vinit_me
                                         * Referenced by: '<S280>/Delay Input1'
                                         */
    uint8_t DetectRisePositive_vinit_o;/* Mask Parameter: DetectRisePositive_vinit_o
                                        * Referenced by: '<S296>/Delay Input1'
                                        */
    uint8_t DetectRisePositive1_vinit_h;/* Mask Parameter: DetectRisePositive1_vinit_h
                                         * Referenced by: '<S281>/Delay Input1'
                                         */
    uint8_t DetectRisePositive_vinit_h;/* Mask Parameter: DetectRisePositive_vinit_h
                                        * Referenced by: '<S309>/Delay Input1'
                                        */
    uint8_t DetectRisePositive_vinit_d;/* Mask Parameter: DetectRisePositive_vinit_d
                                        * Referenced by: '<S291>/Delay Input1'
                                        */
    uint8_t DetectRisePositive_vinit_dn;/* Mask Parameter: DetectRisePositive_vinit_dn
                                         * Referenced by: '<S304>/Delay Input1'
                                         */
    uint8_t DetectRisePositive_vinit_cj;/* Mask Parameter: DetectRisePositive_vinit_cj
                                         * Referenced by: '<S314>/Delay Input1'
                                         */
    uint8_t DetectRisePositive3_vinit; /* Mask Parameter: DetectRisePositive3_vinit
                                        * Referenced by: '<S320>/Delay Input1'
                                        */
    uint8_t DetectRisePositive3_vinit_h;/* Mask Parameter: DetectRisePositive3_vinit_h
    ...
    uint8_t Sensor_Valid_q_low;          /* Mask Parameter: Sensor_Valid_q_low
                                        * Referenced by: '<S393>/Relay'
                                        */
    double Saturation_UpperSat;          /* Expression: 10e7
                                        * Referenced by: '<S179>/Saturation'
                                        */
    double Saturation_LowerSat;          /* Expression: 1e-6
                                        * Referenced by: '<S179>/Saturation'
                                        */
    double Constant_Value;               /* Expression: 1
                                        * Referenced by: '<S179>/Constant'
                                        */
    double Delay1_InitialCondition;      /* Expression: 0.0
                                        * Referenced by: '<S318>/Delay1'
                                        */
    double Delay_InitialCondition;       /* Expression: 0.0
                                        * Referenced by: '<S319>/Delay'
                                        */
    double Delay1_InitialCondition_e;    /* Expression: 0.0
                                        * Referenced by: '<S319>/Delay1'
                                        */
    double lon_0_rad_Y0;                 /* Expression: 0
                                        * Referenced by: '<S349>/lon_0_rad'
                                        */
    double lat_0_rad_Y0;                 /* Expression: 0
                                        * Referenced by: '<S349>/lat_0_rad'
                                        */
    double dx_dlat_Y0;                   /* Expression: 1
                                        * Referenced by: '<S349>/dx_dlat'
                                        */
    double dy_dlon_Y0;                   /* Expression: 1
                                        * Referenced by: '<S349>/dy_dlon'
                                        */
    double dz_dh_Y0;                     /* Expression: 1
                                        * Referenced by: '<S349>/dz_dh'
                                        */
    double Constant_Value_n;             /* Expression: 1
                                        * Referenced by: '<S365>/Constant'
                                        */
    double Constant1_Value;              /* Expression: 1
                                        * Referenced by: '<S365>/Constant1'
                                        */
    double Constant2_Value;              /* Expression: 2
                                        * Referenced by: '<S365>/Constant2'
                                        */
    double R_Value;                      /* Expression: 6378137
                                        * Referenced by: '<S365>/R'
                                        */
    double f_Value;                      /* Expression: 1/298.257223563
    ...
    int32_t Scalefactor2_Gain;           /* Computed Parameter: Scalefactor2_Gain
                                        ...
                                        */
    float DiscreteTimeIntegrator_gainval;/* Computed Parameter: DiscreteTimeIntegrator_gainval
                                           * Referenced by: '<S12>/Discrete-Time Integrator'
                                           */
    float DiscreteTimeIntegrator_IC;  /* Computed Parameter: DiscreteTimeIntegrator_IC
                                        * Referenced by: '<S12>/Discrete-Time Integrator'
                                        */
    float DiscreteTimeIntegrator_UpperSat;/* Computed Parameter: DiscreteTimeIntegrator_UpperSat
                                            * Referenced by: '<S12>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_LowerSat;/* Computed Parameter: DiscreteTimeIntegrator_LowerSat
                                            * Referenced by: '<S12>/Discrete-Time Integrator'
                                            */
    float Gain10_Gain;                /* Computed Parameter: Gain10_Gain
                                        * Referenced by: '<S8>/Gain10'
                                        */
    float DiscreteTimeIntegrator_gainva_i;/* Computed Parameter: DiscreteTimeIntegrator_gainva_i
                                            * Referenced by: '<S15>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_IC_i;/* Computed Parameter: DiscreteTimeIntegrator_IC_i
                                        * Referenced by: '<S15>/Discrete-Time Integrator'
                                        */
    float DiscreteTimeIntegrator_UpperS_g;/* Computed Parameter: DiscreteTimeIntegrator_UpperS_g
                                            * Referenced by: '<S15>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_LowerS_j;/* Computed Parameter: DiscreteTimeIntegrator_LowerS_j
                                            * Referenced by: '<S15>/Discrete-Time Integrator'
                                            */
    float Relay1_OnVal;               /* Computed Parameter: Relay1_OnVal
                                        * Referenced by: '<S9>/Relay1'
                                        */
    float Relay1_OffVal;              /* Computed Parameter: Relay1_OffVal
                                        * Referenced by: '<S9>/Relay1'
                                        */
    float DiscreteTimeIntegrator_gainva_m;/* Computed Parameter: DiscreteTimeIntegrator_gainva_m
                                            * Referenced by: '<S17>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_IC_o;/* Computed Parameter: DiscreteTimeIntegrator_IC_o
                                        * Referenced by: '<S17>/Discrete-Time Integrator'
                                        */
    float DiscreteTimeIntegrator_UpperS_d;/* Computed Parameter: DiscreteTimeIntegrator_UpperS_d
                                            * Referenced by: '<S17>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_LowerS_n;/* Computed Parameter: DiscreteTimeIntegrator_LowerS_n
                                            * Referenced by: '<S17>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_gainva_k;/* Computed Parameter: DiscreteTimeIntegrator_gainva_k
                                            * Referenced by: '<S11>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_IC_l;/* Computed Parameter: DiscreteTimeIntegrator_IC_l
                                        * Referenced by: '<S11>/Discrete-Time Integrator'
                                        */
    float DiscreteTimeIntegrator_UpperS_n;/* Computed Parameter: DiscreteTimeIntegrator_UpperS_n
                                            * Referenced by: '<S11>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_LowerS_l;/* Computed Parameter: DiscreteTimeIntegrator_LowerS_l
                                            * Referenced by: '<S11>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_gainva_p;/* Computed Parameter: DiscreteTimeIntegrator_gainva_p
                                            * Referenced by: '<S13>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_IC_j;/* Computed Parameter: DiscreteTimeIntegrator_IC_j
                                        * Referenced by: '<S13>/Discrete-Time Integrator'
                                        */
    float DiscreteTimeIntegrator_UpperS_f;/* Computed Parameter: DiscreteTimeIntegrator_UpperS_f
                                            * Referenced by: '<S13>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_LowerS_f;/* Computed Parameter: DiscreteTimeIntegrator_LowerS_f
                                            * Referenced by: '<S13>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_gainv_me;/* Computed Parameter: DiscreteTimeIntegrator_gainv_me
                                            * Referenced by: '<S14>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_IC_ig;/* Computed Parameter: DiscreteTimeIntegrator_IC_ig
                                         * Referenced by: '<S14>/Discrete-Time Integrator'
                                         */
    float DiscreteTimeIntegrator_UpperS_m;/* Computed Parameter: DiscreteTimeIntegrator_UpperS_m
                                            * Referenced by: '<S14>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_LowerS_i;/* Computed Parameter: DiscreteTimeIntegrator_LowerS_i
                                            * Referenced by: '<S14>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_gainv_my;/* Computed Parameter: DiscreteTimeIntegrator_gainv_my
                                            * Referenced by: '<S16>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_IC_e;/* Computed Parameter: DiscreteTimeIntegrator_IC_e
                                        * Referenced by: '<S16>/Discrete-Time Integrator'
                                        */
    float DiscreteTimeIntegrator_Upper_ml;/* Computed Parameter: DiscreteTimeIntegrator_Upper_ml
                                            * Referenced by: '<S16>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_LowerS_g;/* Computed Parameter: DiscreteTimeIntegrator_LowerS_g
                                            * Referenced by: '<S16>/Discrete-Time Integrator'
                                            */
    ...
    float Constant_Value_c;           /* Computed Parameter: Constant_Value_c
                                        ...
                                        */
    float Saturation_UpperSat_h;      /* Computed Parameter: Saturation_UpperSat_h
                                        * Referenced by: '<S64>/Saturation'
                                        */
    float Saturation_LowerSat_m;      /* Computed Parameter: Saturation_LowerSat_m
                                        * Referenced by: '<S64>/Saturation'
                                        */
    float Constant1_Value_o;          /* Computed Parameter: Constant1_Value_o
    ...
    float Gain_Gain_f;                /* Computed Parameter: Gain_Gain_f
                                        ...
                                        */
    float Constant_Value_j1;          /* Computed Parameter: Constant_Value_j1
    ...
    float Constant_Value_a;           /* Computed Parameter: Constant_Value_a
                                        ...
                                        */
    float Constant_Value_jy;          /* Computed Parameter: Constant_Value_jy
                                        * Referenced by: '<S82>/Constant'
                                        */
    float gps_acc_O_mPs2_Y0;          /* Computed Parameter: gps_acc_O_mPs2_Y0
    ...
    float Integrator_gainval;         /* Computed Parameter: Integrator_gainval
                                        ...
                                        */
    float Integrator_IC;              /* Computed Parameter: Integrator_IC
                                        * Referenced by: '<S91>/Integrator'
                                        */
    float Integrator1_gainval;        /* Computed Parameter: Integrator1_gainval
    ...
    float Constant_Value_g;           /* Computed Parameter: Constant_Value_g
                                        ...
                                        */
    float DiscreteTimeIntegrator1_gainval;/* Computed Parameter: DiscreteTimeIntegrator1_gainval
                                            * Referenced by: '<S88>/Discrete-Time Integrator1'
                                            */
    float Relay_OnVal;                /* Computed Parameter: Relay_OnVal
                                        * Referenced by: '<S92>/Relay'
                                        */
    float Relay_OffVal;               /* Computed Parameter: Relay_OffVal
                                        * Referenced by: '<S92>/Relay'
                                        */
    float Relay_YOn;                  /* Computed Parameter: Relay_YOn
                                        * Referenced by: '<S92>/Relay'
                                        */
    float Relay_YOff;                 /* Computed Parameter: Relay_YOff
                                        * Referenced by: '<S92>/Relay'
                                        */
    float Delay_InitialCondition_m;   /* Computed Parameter: Delay_InitialCondition_m
                                        * Referenced by: '<S86>/Delay'
                                        */
    float gravity_Value[3];           /* Expression: [0;0;-INS_CONST.g]
                                        * Referenced by: '<S73>/gravity'
                                        */
    float Gain1_Gain_l;               /* Computed Parameter: Gain1_Gain_l
                                        * Referenced by: '<S74>/Gain1'
                                        */
    float Gain2_Gain_i;               /* Computed Parameter: Gain2_Gain_i
                                        * Referenced by: '<S74>/Gain2'
                                        */
    float DeadZone2_Start;            /* Computed Parameter: DeadZone2_Start
                                        * Referenced by: '<S74>/Dead Zone2'
                                        */
    float DeadZone2_End;              /* Computed Parameter: DeadZone2_End
                                        * Referenced by: '<S74>/Dead Zone2'
                                        */
    float Saturation_UpperSat_k;      /* Computed Parameter: Saturation_UpperSat_k
                                        * Referenced by: '<S74>/Saturation'
                                        */
    float Saturation_LowerSat_k;      /* Computed Parameter: Saturation_LowerSat_k
                                        * Referenced by: '<S74>/Saturation'
                                        */
    float Switch_Threshold;           /* Computed Parameter: Switch_Threshold
                                        * Referenced by: '<S81>/Switch'
                                        */
    float Switch_Threshold_m;         /* Computed Parameter: Switch_Threshold_m
                                        * Referenced by: '<S82>/Switch'
                                        */
    float max_Value;                  /* Computed Parameter: max_Value
                                        * Referenced by: '<S80>/max'
                                        */
    float Saturation_UpperSat_e;      /* Computed Parameter: Saturation_UpperSat_e
                                        * Referenced by: '<S80>/Saturation'
                                        */
    float Saturation_LowerSat_fo;     /* Computed Parameter: Saturation_LowerSat_fo
                                        * Referenced by: '<S80>/Saturation'
                                        */
    float Constant1_Value_n;          /* Computed Parameter: Constant1_Value_n
                                        * Referenced by: '<S80>/Constant1'
                                        */
    float Gain_Gain_o[3];             /* Expression: [INS_PARAM.ATT_GAIN;INS_PARAM.ATT_GAIN;0]
                                        * Referenced by: '<S75>/Gain'
                                        */
    float DiscreteTimeIntegrator_gainva_n;/* Computed Parameter: DiscreteTimeIntegrator_gainva_n
                                            * Referenced by: '<S88>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_IC_a;/* Computed Parameter: DiscreteTimeIntegrator_IC_a
                                        * Referenced by: '<S88>/Discrete-Time Integrator'
                                        */
    float Gain_Gain_p;                /* Computed Parameter: Gain_Gain_p
                                        * Referenced by: '<S88>/Gain'
                                        */
    float Gain1_Gain_p;               /* Computed Parameter: Gain1_Gain_p
                                        * Referenced by: '<S88>/Gain1'
                                        */
    float Relay1_OnVal_i;             /* Computed Parameter: Relay1_OnVal_i
                                        * Referenced by: '<S71>/Relay1'
                                        */
    float Relay1_OffVal_o;            /* Computed Parameter: Relay1_OffVal_o
                                        * Referenced by: '<S71>/Relay1'
                                        */
    float Relay1_YOn;                 /* Computed Parameter: Relay1_YOn
                                        * Referenced by: '<S71>/Relay1'
                                        */
    float Relay1_YOff;                /* Computed Parameter: Relay1_YOff
                                        * Referenced by: '<S71>/Relay1'
                                        */
    float Constant_Value_no;          /* Computed Parameter: Constant_Value_no
                                        * Referenced by: '<S95>/Constant'
                                        */
    float DiscreteTimeIntegrator1_gainv_j;/* Computed Parameter: DiscreteTimeIntegrator1_gainv_j
    ...
    float Saturation2_LowerSat;       /* Computed Parameter: Saturation2_LowerSat
                                        * Referenced by: '<S69>/Saturation2'
                                        */
    float DiscreteTimeIntegrator_gainv_kw;/* Computed Parameter: DiscreteTimeIntegrator_gainv_kw
                                            * Referenced by: '<S95>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_IC_m;/* Computed Parameter: DiscreteTimeIntegrator_IC_m
                                        * Referenced by: '<S95>/Discrete-Time Integrator'
                                        */
    ...
    float Constant_Value_p;           /* Computed Parameter: Constant_Value_p
                                        ...
                                        */
    float DiscreteTimeIntegrator_gainva_j;/* Computed Parameter: DiscreteTimeIntegrator_gainva_j
                                            * Referenced by: '<S97>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator2_gainval;/* Computed Parameter: DiscreteTimeIntegrator2_gainval
                                            * Referenced by: '<S98>/Discrete-Time Integrator2'
                                            */
    float DiscreteTimeIntegrator2_IC; /* Computed Parameter: DiscreteTimeIntegrator2_IC
                                        * Referenced by: '<S98>/Discrete-Time Integrator2'
                                        */
    float DiscreteTimeIntegrator2_UpperSa;/* Computed Parameter: DiscreteTimeIntegrator2_UpperSa
                                            * Referenced by: '<S98>/Discrete-Time Integrator2'
                                            */
    float DiscreteTimeIntegrator2_LowerSa;/* Computed Parameter: DiscreteTimeIntegrator2_LowerSa
                                            * Referenced by: '<S98>/Discrete-Time Integrator2'
                                            */
    float Gain2_Gain_i4;              /* Computed Parameter: Gain2_Gain_i4
                                        * Referenced by: '<S97>/Gain2'
                                        */
    float Gain_Gain_e;                /* Computed Parameter: Gain_Gain_e
                                        * Referenced by: '<S108>/Gain'
                                        */
    float Gain1_Gain_pl;              /* Computed Parameter: Gain1_Gain_pl
    ...
    float Gain1_Gain_b;               /* Computed Parameter: Gain1_Gain_b
                                        ...
                                        */
    float Gain_Gain_oz;               /* Computed Parameter: Gain_Gain_oz
                                        * Referenced by: '<S110>/Gain'
                                        */
    float Gain1_Gain_f;               /* Computed Parameter: Gain1_Gain_f
                                        * Referenced by: '<S110>/Gain1'
                                        */
    float Delay_7_InitialCondition;   /* Computed Parameter: Delay_7_InitialCondition
                                        * Referenced by: '<S57>/Delay'
                                        */
    float Delay_8_InitialCondition;   /* Computed Parameter: Delay_8_InitialCondition
                                        * Referenced by: '<S57>/Delay'
                                        */
    float Constant_Value_c0;          /* Computed Parameter: Constant_Value_c0
                                        * Referenced by: '<S139>/Constant'
                                        */
    float Gain_Gain_eu;               /* Computed Parameter: Gain_Gain_eu
                                        * Referenced by: '<S139>/Gain'
                                        */
    float Gain1_Gain_h;               /* Computed Parameter: Gain1_Gain_h
                                        * Referenced by: '<S139>/Gain1'
                                        */
    float Constant2_Value_az[2];      /* Computed Parameter: Constant2_Value_az
                                        * Referenced by: '<S152>/Constant2'
                                        */
    float Constant1_Value_e;          /* Computed Parameter: Constant1_Value_e
                                        * Referenced by: '<S152>/Constant1'
                                        */
    float Constant_Value_ae;          /* Computed Parameter: Constant_Value_ae
    ...
    float Gain4_Gain;                 /* Computed Parameter: Gain4_Gain
                                        ...
                                        */
    float Constant2_Value_o[2];       /* Computed Parameter: Constant2_Value_o
                                        * Referenced by: '<S157>/Constant2'
                                        */
    float Constant1_Value_l;          /* Computed Parameter: Constant1_Value_l
                                        * Referenced by: '<S157>/Constant1'
                                        */
    float Constant_Value_f;           /* Computed Parameter: Constant_Value_f
    ...
    float Gain1_Gain_m;               /* Computed Parameter: Gain1_Gain_m
                                        ...
                                        */
    float Gain2_Gain_o;               /* Computed Parameter: Gain2_Gain_o
                                        * Referenced by: '<S142>/Gain2'
                                        */
    float Gain3_Gain_e;               /* Computed Parameter: Gain3_Gain_e
                                        * Referenced by: '<S142>/Gain3'
                                        */
    float Constant2_Value_m[2];       /* Computed Parameter: Constant2_Value_m
                                        * Referenced by: '<S147>/Constant2'
                                        */
    float Constant1_Value_a;          /* Computed Parameter: Constant1_Value_a
                                        * Referenced by: '<S147>/Constant1'
                                        */
    float Constant_Value_hd;          /* Computed Parameter: Constant_Value_hd
                                        * Referenced by: '<S148>/Constant'
                                        */
    float Gain_Gain_g;                /* Computed Parameter: Gain_Gain_g
                                        * Referenced by: '<S140>/Gain'
                                        */
    float Gain1_Gain_ig;              /* Computed Parameter: Gain1_Gain_ig
                                        * Referenced by: '<S140>/Gain1'
                                        */
    float Gain2_Gain_m;               /* Computed Parameter: Gain2_Gain_m
                                        * Referenced by: '<S140>/Gain2'
                                        */
    float Gain3_Gain_ea;              /* Computed Parameter: Gain3_Gain_ea
                                        * Referenced by: '<S140>/Gain3'
                                        */
    float Constant_Value_h1;          /* Computed Parameter: Constant_Value_h1
                                        * Referenced by: '<S130>/Constant'
                                        */
    float Constant_Value_aee;         /* Computed Parameter: Constant_Value_aee
                                        * Referenced by: '<S131>/Constant'
                                        */
    float Constant_Value_hp;          /* Computed Parameter: Constant_Value_hp
                                        * Referenced by: '<S132>/Constant'
                                        */
    float quat_0_Y0[4];               /* Computed Parameter: quat_0_Y0
                                        * Referenced by: '<S113>/quat_0'
                                        */
    float Gain_Gain_d;                /* Computed Parameter: Gain_Gain_d
                                        * Referenced by: '<S113>/Gain'
                                        */
    float Switch_Threshold_a;         /* Computed Parameter: Switch_Threshold_a
                                        * Referenced by: '<S130>/Switch'
                                        */
    float Switch_Threshold_f;         /* Computed Parameter: Switch_Threshold_f
                                        * Referenced by: '<S131>/Switch'
                                        */
    float Switch_Threshold_mm;        /* Computed Parameter: Switch_Threshold_mm
                                        * Referenced by: '<S132>/Switch'
                                        */
    float Merge_InitialOutput;        /* Computed Parameter: Merge_InitialOutput
                                        * Referenced by: '<S129>/Merge'
                                        */
    float DiscreteTimeIntegrator5_gainval;/* Computed Parameter: DiscreteTimeIntegrator5_gainval
                                            * Referenced by: '<S165>/Discrete-Time Integrator5'
                                            */
    float Gain_Gain_fr;               /* Computed Parameter: Gain_Gain_fr
                                        * Referenced by: '<S165>/Gain'
                                        */
    float DiscreteTimeIntegrator5_gainv_n;/* Computed Parameter: DiscreteTimeIntegrator5_gainv_n
                                            * Referenced by: '<S163>/Discrete-Time Integrator5'
                                            */
    float Gain_Gain_je;               /* Computed Parameter: Gain_Gain_je
                                        * Referenced by: '<S163>/Gain'
                                        */
    float Saturation2_UpperSat_i;     /* Computed Parameter: Saturation2_UpperSat_i
                                        * Referenced by: '<S114>/Saturation2'
                                        */
    float Saturation2_LowerSat_g;     /* Computed Parameter: Saturation2_LowerSat_g
                                        * Referenced by: '<S114>/Saturation2'
                                        */
    float DiscreteTimeIntegrator5_gainv_m;/* Computed Parameter: DiscreteTimeIntegrator5_gainv_m
                                            * Referenced by: '<S164>/Discrete-Time Integrator5'
                                            */
    float Gain_Gain_h;                /* Computed Parameter: Gain_Gain_h
                                        * Referenced by: '<S164>/Gain'
                                        */
    float Relay_OnVal_g;              /* Computed Parameter: Relay_OnVal_g
                                        * Referenced by: '<S114>/Relay'
                                        */
    float Relay_OffVal_f;             /* Computed Parameter: Relay_OffVal_f
                                        * Referenced by: '<S114>/Relay'
                                        */
    float Relay_YOn_k;                /* Computed Parameter: Relay_YOn_k
                                        * Referenced by: '<S114>/Relay'
                                        */
    float Relay_YOff_f;               /* Computed Parameter: Relay_YOff_f
                                        * Referenced by: '<S114>/Relay'
                                        */
    float X_Next_Y0;                  /* Computed Parameter: X_Next_Y0
                                        * Referenced by: '<S184>/X_Next'
                                        */
    float Memory_InitialCondition[2]; /* Computed Parameter: Memory_InitialCondition
                                        * Referenced by: '<S191>/Memory'
                                        */
    float Memory_InitialCondition_o;  /* Computed Parameter: Memory_InitialCondition_o
                                        * Referenced by: '<S186>/Memory'
                                        */
    float Gain3_Gain_o;               /* Expression: INS_CONST.dt
                                        * Referenced by: '<S186>/Gain3'
                                        */
    float Constant_Value_o[2];        /* Computed Parameter: Constant_Value_o
                                        * Referenced by: '<S197>/Constant'
                                        */
    float X_Next_Y0_k;                /* Computed Parameter: X_Next_Y0_k
                                        * Referenced by: '<S194>/X_Next'
                                        */
    float Memory_InitialCondition_i;  /* Computed Parameter: Memory_InitialCondition_i
                                        * Referenced by: '<S196>/Memory'
                                        */
    float Gain3_Gain_p;               /* Expression: INS_CONST.dt
                                        * Referenced by: '<S196>/Gain3'
                                        */
    float Constant_Value_b[2];        /* Computed Parameter: Constant_Value_b
                                        * Referenced by: '<S202>/Constant'
                                        */
    float X_0_Y0;                     /* Computed Parameter: X_0_Y0
                                        * Referenced by: '<S205>/X_0'
                                        */
    float Saturation_UpperSat_b;      /* Computed Parameter: Saturation_UpperSat_b
                                        * Referenced by: '<S216>/Saturation'
                                        */
    float Saturation_LowerSat_c;      /* Computed Parameter: Saturation_LowerSat_c
                                        * Referenced by: '<S216>/Saturation'
                                        */
    float X_Next_Y0_m;                /* Computed Parameter: X_Next_Y0_m
                                        * Referenced by: '<S213>/X_Next'
                                        */
    float Delay_InitialCondition_j;   /* Computed Parameter: Delay_InitialCondition_j
                                        * Referenced by: '<S215>/Delay'
                                        */
    float Delay_InitialCondition_mk;  /* Computed Parameter: Delay_InitialCondition_mk
                                        * Referenced by: '<S219>/Delay'
                                        */
    float Gain_Gain_pl;               /* Expression: INS_CONST.dt
                                        * Referenced by: '<S215>/Gain'
                                        */
    float Saturation_UpperSat_as;     /* Computed Parameter: Saturation_UpperSat_as
                                        * Referenced by: '<S213>/Saturation'
                                        */
    float Saturation_LowerSat_e;      /* Computed Parameter: Saturation_LowerSat_e
                                        * Referenced by: '<S213>/Saturation'
                                        */
    float X_Next_Y0_i;                /* Computed Parameter: X_Next_Y0_i
                                        * Referenced by: '<S222>/X_Next'
                                        */
    float Memory_InitialCondition_p;  /* Computed Parameter: Memory_InitialCondition_p
                                        * Referenced by: '<S228>/Memory'
                                        */
    float Memory_InitialCondition_c;  /* Computed Parameter: Memory_InitialCondition_c
                                        * Referenced by: '<S224>/Memory'
                                        */
    float Gain3_Gain_k;               /* Expression: INS_CONST.dt
                                        * Referenced by: '<S224>/Gain3'
                                        */
    float Saturation_UpperSat_i;      /* Computed Parameter: Saturation_UpperSat_i
                                        * Referenced by: '<S234>/Saturation'
                                        */
    float Saturation_LowerSat_h;      /* Computed Parameter: Saturation_LowerSat_h
                                        * Referenced by: '<S234>/Saturation'
                                        */
    float X_Next_Y0_mm;               /* Computed Parameter: X_Next_Y0_mm
                                        * Referenced by: '<S231>/X_Next'
                                        */
    float rf_bias_Y0;                 /* Computed Parameter: rf_bias_Y0
                                        * Referenced by: '<S231>/rf_bias'
                                        */
    float Delay_InitialCondition_mg;  /* Computed Parameter: Delay_InitialCondition_mg
                                        * Referenced by: '<S240>/Delay'
                                        */
    float udT_Gain;                   /* Computed Parameter: udT_Gain
                                        * Referenced by: '<S240>/1//dT'
                                        */
    float Memory_InitialCondition_o5; /* Computed Parameter: Memory_InitialCondition_o5
                                        * Referenced by: '<S237>/Memory'
                                        */
    float Memory_InitialCondition_h;  /* Computed Parameter: Memory_InitialCondition_h
                                        * Referenced by: '<S233>/Memory'
                                        */
    float Gain3_Gain_j;               /* Expression: INS_CONST.dt
    ...
    float Merge_InitialOutput_d;      /* Computed Parameter: Merge_InitialOutput_d
                                        ...
                                        */
    float Delay_InitialCondition_mt;  /* Computed Parameter: Delay_InitialCondition_mt
                                        * Referenced by: '<S242>/Delay'
                                        */
    float Gain1_Gain_k;               /* Computed Parameter: Gain1_Gain_k
                                        * Referenced by: '<S243>/Gain1'
                                        */
    float Constant_Value_nn;          /* Computed Parameter: Constant_Value_nn
                                        * Referenced by: '<S243>/Constant'
                                        */
    float Gain_Gain_m;                /* Expression: INS_CONST.dt
                                        * Referenced by: '<S243>/Gain'
                                        */
    float Merge_InitialOutput_c;      /* Computed Parameter: Merge_InitialOutput_c
                                        * Referenced by: '<S204>/Merge'
                                        */
    float Delay_InitialCondition_g;   /* Computed Parameter: Delay_InitialCondition_g
                                        * Referenced by: '<S200>/Delay'
                                        */
    float Constant_Value_l[2];        /* Computed Parameter: Constant_Value_l
                                        * Referenced by: '<S201>/Constant'
                                        */
    float Gain_Gain_ic;               /* Expression: INS_CONST.dt
                                        * Referenced by: '<S201>/Gain'
                                        */
    float Relay_OnVal_l;              /* Computed Parameter: Relay_OnVal_l
                                        * Referenced by: '<S274>/Relay'
                                        */
    float Relay_OffVal_p;             /* Computed Parameter: Relay_OffVal_p
                                        * Referenced by: '<S274>/Relay'
                                        */
    float Relay_YOn_b;                /* Computed Parameter: Relay_YOn_b
                                        * Referenced by: '<S274>/Relay'
                                        */
    float Relay_YOff_d;               /* Computed Parameter: Relay_YOff_d
                                        * Referenced by: '<S274>/Relay'
                                        */
    float Relay1_OnVal_b;             /* Computed Parameter: Relay1_OnVal_b
                                        * Referenced by: '<S274>/Relay1'
                                        */
    float Relay1_OffVal_n;            /* Computed Parameter: Relay1_OffVal_n
                                        * Referenced by: '<S274>/Relay1'
                                        */
    float Relay1_YOn_b;               /* Computed Parameter: Relay1_YOn_b
                                        * Referenced by: '<S274>/Relay1'
                                        */
    float Relay1_YOff_a;              /* Computed Parameter: Relay1_YOff_a
                                        * Referenced by: '<S274>/Relay1'
                                        */
    float Constant_Value_oi;          /* Computed Parameter: Constant_Value_oi
                                        * Referenced by: '<S272>/Constant'
                                        */
    float DiscreteTimeIntegrator_gainva_b;/* Computed Parameter: DiscreteTimeIntegrator_gainva_b
                                            * Referenced by: '<S272>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_IC_c;/* Computed Parameter: DiscreteTimeIntegrator_IC_c
                                        * Referenced by: '<S272>/Discrete-Time Integrator'
                                        */
    float DiscreteTimeIntegrator1_gainv_d;/* Computed Parameter: DiscreteTimeIntegrator1_gainv_d
    ...
    float Gain1_Gain_c;               /* Computed Parameter: Gain1_Gain_c
                                        ...
                                        */
    float Constant_Value_gd;          /* Computed Parameter: Constant_Value_gd
                                        * Referenced by: '<S270>/Constant'
                                        */
    float DiscreteTimeIntegrator_gainv_bt;/* Computed Parameter: DiscreteTimeIntegrator_gainv_bt
                                            * Referenced by: '<S287>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_IC_g;/* Computed Parameter: DiscreteTimeIntegrator_IC_g
                                        * Referenced by: '<S287>/Discrete-Time Integrator'
                                        */
    float DiscreteTimeIntegrator_UpperS_p;/* Computed Parameter: DiscreteTimeIntegrator_UpperS_p
                                            * Referenced by: '<S287>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_LowerS_p;/* Computed Parameter: DiscreteTimeIntegrator_LowerS_p
                                            * Referenced by: '<S287>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_gainv_jo;/* Computed Parameter: DiscreteTimeIntegrator_gainv_jo
                                            * Referenced by: '<S299>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_IC_lb;/* Computed Parameter: DiscreteTimeIntegrator_IC_lb
                                         * Referenced by: '<S299>/Discrete-Time Integrator'
                                         */
    float DiscreteTimeIntegrator_UpperS_j;/* Computed Parameter: DiscreteTimeIntegrator_UpperS_j
                                            * Referenced by: '<S299>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_Lower_f2;/* Computed Parameter: DiscreteTimeIntegrator_Lower_f2
                                            * Referenced by: '<S299>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_gainv_iy;/* Computed Parameter: DiscreteTimeIntegrator_gainv_iy
                                            * Referenced by: '<S286>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_IC_b;/* Computed Parameter: DiscreteTimeIntegrator_IC_b
                                        * Referenced by: '<S286>/Discrete-Time Integrator'
                                        */
    float DiscreteTimeIntegrator_Upper_jm;/* Computed Parameter: DiscreteTimeIntegrator_Upper_jm
                                            * Referenced by: '<S286>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_LowerS_d;/* Computed Parameter: DiscreteTimeIntegrator_LowerS_d
                                            * Referenced by: '<S286>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_gainva_a;/* Computed Parameter: DiscreteTimeIntegrator_gainva_a
                                            * Referenced by: '<S298>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_IC_h;/* Computed Parameter: DiscreteTimeIntegrator_IC_h
                                        * Referenced by: '<S298>/Discrete-Time Integrator'
                                        */
    float DiscreteTimeIntegrator_Upper_fv;/* Computed Parameter: DiscreteTimeIntegrator_Upper_fv
                                            * Referenced by: '<S298>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_LowerS_b;/* Computed Parameter: DiscreteTimeIntegrator_LowerS_b
                                            * Referenced by: '<S298>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_gainv_jp;/* Computed Parameter: DiscreteTimeIntegrator_gainv_jp
                                            * Referenced by: '<S300>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_IC_ms;/* Computed Parameter: DiscreteTimeIntegrator_IC_ms
                                         * Referenced by: '<S300>/Discrete-Time Integrator'
                                         */
    float DiscreteTimeIntegrator_UpperS_e;/* Computed Parameter: DiscreteTimeIntegrator_UpperS_e
                                            * Referenced by: '<S300>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_Lower_no;/* Computed Parameter: DiscreteTimeIntegrator_Lower_no
                                            * Referenced by: '<S300>/Discrete-Time Integrator'
                                            */
    float Delay_4_InitialCondition;   /* Computed Parameter: Delay_4_InitialCondition
                                        * Referenced by: '<S56>/Delay'
                                        */
    float Delay_5_InitialCondition;   /* Computed Parameter: Delay_5_InitialCondition
                                        * Referenced by: '<S56>/Delay'
                                        */
    float Delay_6_InitialCondition;   /* Computed Parameter: Delay_6_InitialCondition
                                        * Referenced by: '<S56>/Delay'
                                        */
    float AirDensity_15C_Value;       /* Computed Parameter: AirDensity_15C_Value
                                        * Referenced by: '<S331>/AirDensity_15C'
                                        */
    float Gain_Gain_ozb;              /* Computed Parameter: Gain_Gain_ozb
                                        * Referenced by: '<S331>/Gain'
                                        */
    float Saturation1_UpperSat_i;     /* Computed Parameter: Saturation1_UpperSat_i
                                        * Referenced by: '<S324>/Saturation1'
                                        */
    float Saturation1_LowerSat_n;     /* Computed Parameter: Saturation1_LowerSat_n
                                        * Referenced by: '<S324>/Saturation1'
                                        */
    float h_R_m_Y0;                   /* Computed Parameter: h_R_m_Y0
                                        * Referenced by: '<S335>/h_R_m'
                                        */
    float Delay_InitialCondition_p;   /* Computed Parameter: Delay_InitialCondition_p
                                        * Referenced by: '<S335>/Delay'
                                        */
    float Gain1_Gain_a;               /* Computed Parameter: Gain1_Gain_a
                                        * Referenced by: '<S332>/Gain1'
                                        */
    float p1_Value;                   /* Computed Parameter: p1_Value
                                        * Referenced by: '<S332>/p1'
                                        */
    float aR_g_Value;                 /* Computed Parameter: aR_g_Value
                                        * Referenced by: '<S332>/aR_g'
                                        */
    float T1_Value;                   /* Computed Parameter: T1_Value
                                        * Referenced by: '<S332>/T1'
                                        */
    float a_Value;                    /* Computed Parameter: a_Value
                                        * Referenced by: '<S332>/a'
                                        */
    float Constant_Value_n5;          /* Computed Parameter: Constant_Value_n5
                                        * Referenced by: '<S362>/Constant'
                                        */
    float Saturation1_UpperSat_m;     /* Computed Parameter: Saturation1_UpperSat_m
                                        * Referenced by: '<S353>/Saturation1'
                                        */
    float Saturation1_LowerSat_d;     /* Computed Parameter: Saturation1_LowerSat_d
                                        * Referenced by: '<S353>/Saturation1'
                                        */
    float DiscreteTimeIntegrator1_gainv_b;/* Computed Parameter: DiscreteTimeIntegrator1_gainv_b
    ...
    float Saturation_UpperSat_l;      /* Computed Parameter: Saturation_UpperSat_l
                                        ...
                                        */
    float Saturation_LowerSat_ku;     /* Computed Parameter: Saturation_LowerSat_ku
                                        * Referenced by: '<S354>/Saturation'
                                        */
    float DiscreteTimeIntegrator1_gainv_e;/* Computed Parameter: DiscreteTimeIntegrator1_gainv_e
                                            * Referenced by: '<S363>/Discrete-Time Integrator1'
                                            */
    float DiscreteTimeIntegrator_gainva_g;/* Computed Parameter: DiscreteTimeIntegrator_gainva_g
                                            * Referenced by: '<S362>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_IC_d;/* Computed Parameter: DiscreteTimeIntegrator_IC_d
                                        * Referenced by: '<S362>/Discrete-Time Integrator'
                                        */
    float Gain_Gain_j2;               /* Computed Parameter: Gain_Gain_j2
                                        * Referenced by: '<S362>/Gain'
                                        */
    float Gain1_Gain_kf;              /* Computed Parameter: Gain1_Gain_kf
                                        * Referenced by: '<S362>/Gain1'
                                        */
    float DiscreteTimeIntegrator_gainv_mf;/* Computed Parameter: DiscreteTimeIntegrator_gainv_mf
                                            * Referenced by: '<S363>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_IC_f;/* Computed Parameter: DiscreteTimeIntegrator_IC_f
                                        * Referenced by: '<S363>/Discrete-Time Integrator'
                                        */
    float Gain_Gain_gh;               /* Computed Parameter: Gain_Gain_gh
                                        * Referenced by: '<S363>/Gain'
                                        */
    float Gain1_Gain_cj;              /* Computed Parameter: Gain1_Gain_cj
                                        * Referenced by: '<S363>/Gain1'
                                        */
    float default_mag_quality_Value;  /* Computed Parameter: default_mag_quality_Value
                                        * Referenced by: '<S376>/default_mag_quality'
                                        */
    float Constant_Value_hy;          /* Computed Parameter: Constant_Value_hy
                                        * Referenced by: '<S386>/Constant'
                                        */
    float Switch_Threshold_b;         /* Computed Parameter: Switch_Threshold_b
                                        * Referenced by: '<S386>/Switch'
                                        */
    float Constant1_Value_l1;         /* Computed Parameter: Constant1_Value_l1
                                        * Referenced by: '<S387>/Constant1'
                                        */
    float Constant_Value_a1;          /* Computed Parameter: Constant_Value_a1
                                        * Referenced by: '<S385>/Constant'
                                        */
    float Constant1_Value_i;          /* Computed Parameter: Constant1_Value_i
                                        * Referenced by: '<S385>/Constant1'
                                        */
    float Constant2_Value_mb;         /* Computed Parameter: Constant2_Value_mb
                                        * Referenced by: '<S385>/Constant2'
                                        */
    float Constant4_Value_c;          /* Computed Parameter: Constant4_Value_c
                                        * Referenced by: '<S385>/Constant4'
                                        */
    float Gain_Gain_gg;               /* Computed Parameter: Gain_Gain_gg
                                        * Referenced by: '<S377>/Gain'
                                        */
    float Gain_Gain_bo;               /* Computed Parameter: Gain_Gain_bo
                                        * Referenced by: '<S385>/Gain'
                                        */
    float Constant3_Value_f;          /* Computed Parameter: Constant3_Value_f
                                        * Referenced by: '<S385>/Constant3'
                                        */
    float Gauss_to_uT_Gain;           /* Computed Parameter: Gauss_to_uT_Gain
                                        * Referenced by: '<S328>/Gauss_to_uT'
                                        */
    float Gain1_Gain_o;               /* Computed Parameter: Gain1_Gain_o
                                        * Referenced by: '<S380>/Gain1'
                                        */
    float Constant2_Value_h;          /* Computed Parameter: Constant2_Value_h
                                        * Referenced by: '<S380>/Constant2'
                                        */
    float gain_Gain_g;                /* Computed Parameter: gain_Gain_g
                                        * Referenced by: '<S380>/gain'
                                        */
    float Saturation_UpperSat_g;      /* Computed Parameter: Saturation_UpperSat_g
                                        * Referenced by: '<S380>/Saturation'
                                        */
    float Saturation_LowerSat_a;      /* Computed Parameter: Saturation_LowerSat_a
                                        * Referenced by: '<S380>/Saturation'
                                        */
    float Nominal_Magnitude_Value;    /* Computed Parameter: Nominal_Magnitude_Value
    ...
    float gain_Gain_m;                /* Computed Parameter: gain_Gain_m
                                        ...
                                        */
    float Saturation_UpperSat_gv;     /* Computed Parameter: Saturation_UpperSat_gv
                                        * Referenced by: '<S381>/Saturation'
                                        */
    float Saturation_LowerSat_p;      /* Computed Parameter: Saturation_LowerSat_p
                                        * Referenced by: '<S381>/Saturation'
                                        */
    float Constant_Value_fn;          /* Computed Parameter: Constant_Value_fn
                                        * Referenced by: '<S382>/Constant'
                                        */
    float DiscreteTimeIntegrator_gainv_bm;/* Computed Parameter: DiscreteTimeIntegrator_gainv_bm
                                            * Referenced by: '<S382>/Discrete-Time Integrator'
                                            */
    float DiscreteTimeIntegrator_IC_mb;/* Computed Parameter: DiscreteTimeIntegrator_IC_mb
                                         * Referenced by: '<S382>/Discrete-Time Integrator'
                                         */
    float DiscreteTimeIntegrator1_gainv_m;/* Computed Parameter: DiscreteTimeIntegrator1_gainv_m
                                            * Referenced by: '<S382>/Discrete-Time Integrator1'
                                            */
    float Gain_Gain_c;                /* Computed Parameter: Gain_Gain_c
                                        * Referenced by: '<S382>/Gain'
                                        */
    float Gain1_Gain_bn;              /* Computed Parameter: Gain1_Gain_bn
                                        * Referenced by: '<S382>/Gain1'
                                        */
    float DiscreteTimeIntegrator5_gainv_c;/* Computed Parameter: DiscreteTimeIntegrator5_gainv_c
                                            * Referenced by: '<S394>/Discrete-Time Integrator5'
                                            */
    float Gain_Gain_ca;               /* Computed Parameter: Gain_Gain_ca
                                        * Referenced by: '<S394>/Gain'
                                        */
    float Delay_2_InitialCondition;   /* Computed Parameter: Delay_2_InitialCondition
                                        * Referenced by: '<Root>/Delay'
                                        */
    float Delay_3_InitialCondition;   /* Computed Parameter: Delay_3_InitialCondition
                                        * Referenced by: '<Root>/Delay'
                                        */
    float Delay_8_InitialCondition_m; /* Computed Parameter: Delay_8_InitialCondition_m
                                        * Referenced by: '<Root>/Delay'
                                        */
    ...
    uint16_t Constant_Value_pti;         /* Computed Parameter: Constant_Value_pti
                                        ...
                                        */
    uint8_t Delay_InitialCondition_go; /* Computed Parameter: Delay_InitialCondition_go
                                        * Referenced by: '<S12>/Delay'
                                        */
    uint8_t Delay_InitialCondition_mz; /* Computed Parameter: Delay_InitialCondition_mz
                                        * Referenced by: '<S15>/Delay'
                                        */
    uint8_t Relay1_YOn_i;              /* Computed Parameter: Relay1_YOn_i
                                        * Referenced by: '<S9>/Relay1'
                                        */
    uint8_t Relay1_YOff_k;             /* Computed Parameter: Relay1_YOff_k
                                        * Referenced by: '<S9>/Relay1'
                                        */
    uint8_t Delay_InitialCondition_a;  /* Computed Parameter: Delay_InitialCondition_a
                                        * Referenced by: '<S17>/Delay'
                                        */
    uint8_t Delay_InitialCondition_c;  /* Computed Parameter: Delay_InitialCondition_c
                                        * Referenced by: '<S11>/Delay'
                                        */
    uint8_t Delay_InitialCondition_cj; /* Computed Parameter: Delay_InitialCondition_cj
                                        * Referenced by: '<S13>/Delay'
                                        */
    uint8_t Delay_InitialCondition_ae; /* Computed Parameter: Delay_InitialCondition_ae
                                        * Referenced by: '<S14>/Delay'
                                        */
    uint8_t Delay_InitialCondition_e;  /* Computed Parameter: Delay_InitialCondition_e
                                        * Referenced by: '<S16>/Delay'
                                        */
    uint8_t Constant_Value_mt;         /* Computed Parameter: Constant_Value_mt
                                        * Referenced by: '<S22>/Constant'
                                        */
    uint8_t Constant_Value_m2;         /* Computed Parameter: Constant_Value_m2
                                        * Referenced by: '<S27>/Constant'
                                        */
    uint8_t Constant_Value_o2;         /* Computed Parameter: Constant_Value_o2
                                        * Referenced by: '<S32>/Constant'
                                        */
    uint8_t Constant_Value_hk;         /* Computed Parameter: Constant_Value_hk
                                        * Referenced by: '<S37>/Constant'
                                        */
    uint8_t Constant_Value_l1;         /* Computed Parameter: Constant_Value_l1
                                        * Referenced by: '<S42>/Constant'
                                        */
    uint8_t Constant_Value_m2n;        /* Computed Parameter: Constant_Value_m2n
                                        * Referenced by: '<S47>/Constant'
                                        */
    uint8_t Constant_Value_ao;         /* Computed Parameter: Constant_Value_ao
                                        * Referenced by: '<S52>/Constant'
                                        */
    uint8_t Constant_Value_af;         /* Computed Parameter: Constant_Value_af
                                        * Referenced by: '<S123>/Constant'
                                        */
    uint8_t Constant_Value_ps;         /* Computed Parameter: Constant_Value_ps
                                        * Referenced by: '<S262>/Constant'
                                        */
    uint8_t Constant_Value_pf;         /* Computed Parameter: Constant_Value_pf
                                        * Referenced by: '<S263>/Constant'
                                        */
    uint8_t Constant_Value_ha;         /* Computed Parameter: Constant_Value_ha
                                        * Referenced by: '<S264>/Constant'
                                        */
    uint8_t Constant_Value_d;          /* Computed Parameter: Constant_Value_d
                                        * Referenced by: '<S297>/Constant'
                                        */
    uint8_t Delay_InitialCondition_in; /* Computed Parameter: Delay_InitialCondition_in
                                        * Referenced by: '<S287>/Delay'
                                        */
    uint8_t Constant_Value_jo;         /* Computed Parameter: Constant_Value_jo
                                        * Referenced by: '<S310>/Constant'
                                        */
    uint8_t Delay_InitialCondition_ns; /* Computed Parameter: Delay_InitialCondition_ns
                                        * Referenced by: '<S299>/Delay'
                                        */
    uint8_t Delay_InitialCondition_k;  /* Computed Parameter: Delay_InitialCondition_k
                                        * Referenced by: '<S286>/Delay'
                                        */
    uint8_t Constant_Value_nm;         /* Computed Parameter: Constant_Value_nm
                                        * Referenced by: '<S292>/Constant'
                                        */
    uint8_t Delay_InitialCondition_d;  /* Computed Parameter: Delay_InitialCondition_d
                                        * Referenced by: '<S298>/Delay'
                                        */
    uint8_t Constant_Value_ej;         /* Computed Parameter: Constant_Value_ej
                                        * Referenced by: '<S305>/Constant'
                                        */
    uint8_t Delay_InitialCondition_ia; /* Computed Parameter: Delay_InitialCondition_ia
                                        * Referenced by: '<S300>/Delay'
                                        */
    ...
    uint8_t Delay_InitialCondition_f;  /* Computed Parameter: Delay_InitialCondition_f
                                        * Referenced by: '<S397>/Delay'
                                        */
    uint8_t Constant_Value_pa;         /* Computed Parameter: Constant_Value_pa
